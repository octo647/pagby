            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                ...
                <form wire:submit.prevent="salvarCustomizacoes">
                    ...
                    @if($activeTab === 'cores')
                        <!-- ABA: Cores -->
                        <div class="space-y-6">
                            <h3 class="text-lg font-semibold text-gray-800 mb-4">Paleta de Cores</h3>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center space-x-3">
                                        <input 
                                            ...
                                            class="h-12 w-16 cursor-pointer rounded border border-gray-300"
                                        >
                                        <input 
                                            type="text" 
                                            wire:model="corPrimaria"
                                            class="flex-1 px-3 py-2 border border-gray-300 rounded-md"
                                            placeholder="#2c3e50"
                                        >
                                    </div>
                                    <p class="text-xs text-gray-500 mt-1">Usada em títulos e menus</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <input 
                                            type="text" 
                                            wire:model="corSecundaria"
                                            class="flex-1 px-3 py-2 border border-gray-300 rounded-md"
                                            placeholder="#3498db"
                                        >
                                    </div>
                                    <p class="text-xs text-gray-500 mt-1">Usada em botões e links</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <input 
                                            type="text" 
                                            wire:model="corDestaque"
                                            class="flex-1 px-3 py-2 border border-gray-300 rounded-md"
                                            placeholder="#e74c3c"
                                        >
                                    </div>
                                    <p class="text-xs text-gray-500 mt-1">Usada para elementos de ênfase</p>
                                </div>
                            </div>
                        </div>
                    @endif
                    ...
                    @if($activeTab === 'hero')
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea 
                                    wire:model="heroSubtitulo"
                                    class="w-full px-4 py-3 border border-gray-300 rounded-md"
                                    rows="3"
                                    placeholder="Ex: Oferecemos os melhores serviços com qualidade e dedicação"
                                ></textarea>
                                <p class="text-xs text-gray-500 mt-1">Texto descritivo que aparece abaixo do título</p>
                            </div>
                        </div>
                    @endif
                        ...
                        <div>
                            ...
                            <div class="border-2 border-gray-200 rounded-lg p-6" style="background: linear-gradient(135deg, {{ $corPrimaria }} 0%, {{ $corSecundaria }} 100%);">
                                <div class="text-white text-center">
                                    ...
                                    <p class="text-lg opacity-90 mb-6">{{ $heroSubtitulo ?: 'Seu subtítulo aqui' }}</p>
