            ...
            <div class="text-center">
                ...
                <div class="bg-blue-50 border-2 border-blue-300 rounded-lg p-6 mb-6">
                    ...
                    <div class="text-blue-800 text-left space-y-3">
                        <div>
                            ...
                            <a href="http://<?php echo e($tenant_domain); ?>" target="_blank" 
                               class="text-blue-600 hover:text-blue-800 font-mono text-lg underline break-all">
                                <?php echo e($tenant_domain); ?>

                            </a>
                        </div>
                        <div>
                            <strong class="block text-sm text-gray-600 mb-1">Email de acesso:</strong>
                            <span class="font-mono"><?php echo e(session('contact_email') ?? 'Verifique seu e-mail'); ?></span>
                        </div>
                ...
                <div class="mt-8 pt-6 border-t border-gray-200">
                    ...
                    <div class="text-sm text-gray-600 space-y-1">
                        <?php if(isset($contact_id)): ?>
                            <p><strong>ID do Registro:</strong> #<?php echo e($contact_id); ?></p>
                        <?php endif; ?>
                        <?php if(isset($selected_plan)): ?>
                            <p><strong>Plano:</strong> <?php echo e(ucfirst($selected_plan)); ?></p>
                        <?php endif; ?>
                        <p><strong>Data:</strong> <?php echo e(now()->format('d/m/Y H:i')); ?></p>
                    </div>
                </div>
                ...
                <div class="mt-6 pt-6 border-t border-gray-200">
                    ...
                    <div class="text-sm text-gray-600">
                        ...
                        <p><a href="https://wa.me/<?php echo e(config('pagby.whatsapp_number')); ?>" class="text-blue-500">📱 WhatsApp: <?php echo e(config('pagby.whatsapp_display')); ?></a></p>
                    </div>
                </div>
...
<?php endif; ?><?php /**PATH /var/www/pagby/resources/views/registration-success.blade.php ENDPATH**/ ?>