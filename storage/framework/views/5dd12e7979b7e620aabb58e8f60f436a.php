<div class="space-y-6">
    ...
    <!--[if BLOCK]><![endif]--><?php if($vinculos->isEmpty()): ?>
    ...
    <?php else: ?>
        <div class="space-y-4">
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $vinculos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $servico): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <!--[if BLOCK]><![endif]--><?php if($servico->produtosRecomendados->isNotEmpty()): ?>
                    <div class="bg-white rounded-xl shadow-md overflow-hidden">
                        ...
                        <div class="divide-y divide-gray-200">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $servico->produtosRecomendados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="flex items-center gap-4 flex-1">
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <div class="flex items-center gap-3 mt-1 text-xs text-gray-500">
                                                    ...
                                                    <!--[if BLOCK]><![endif]--><?php if($produto->pivot->discount_percentage): ?>
                                                        <span class="text-green-600 font-medium">🏷️ <?php echo e($produto->pivot->discount_percentage); ?>% OFF</span>
                                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                                </div>
                                                <!--[if BLOCK]><![endif]--><?php if($produto->pivot->observacoes): ?>
                                        ...
                                        <div class="flex items-center gap-2">
                                            ...
                                            <button wire:click="toggleAtivo(<?php echo e($servico->id); ?>, <?php echo e($produto->id); ?>)"
                                                    class="px-3 py-1 rounded-lg text-xs font-medium transition
                                                           ...
                                                           <?php endif; ?>">
                                                <!--[if BLOCK]><![endif]--><?php if($produto->pivot->is_active): ?>
                                                    ✓ Ativo
                                                <?php else: ?>
                                                    ✕ Inativo
                                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
...
<?php /**PATH /home/helder/projetos/pagby/resources/views/livewire/proprietario/fidelidade/vinculos.blade.php ENDPATH**/ ?>