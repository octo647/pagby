...
<head>
    ...
    <title><?php echo e(tenant()->fantasy_name ?? 'Barbearia Urbana'); ?> | Estilo Jovem</title>
    ...
    <style>
        ...
        * {
        ...
        .hero {
            height: 100vh;
            background: linear-gradient(135deg, rgba(108, 99, 255, 0.2), rgba(255, 101, 132, 0.2)), url('/images/Templates/Barbearias/Estilo Urbano/barber.webp') no-repeat center center/cover;
        ...
        <div class="container">
            <nav class="navbar">
                <a href="#" class="logo">
                   ...
                   <?php echo tenant()->fantasy_name ?? 'BARBEARIA <span>URBANA</span>'; ?> 
                </a>
    ...
    <section class="sobre" id="sobre">
        <div class="container">
            <div class="sobre-content">
                <div class="sobre-img">
                    <img src="/images/Templates/Barbearias/Estilo Urbano/photo.avif" alt="Ambiente da barbearia">
                </div>
                <div class="sobre-text">
                    <h2>MAIS DO QUE UMA BARBEARIA, UM PONTO DE ENCONTRO</h2>
                    <p>A <?php echo e(tenant()->fantasy_name ?? 'Barbearia Urbana'); ?> nasceu para ser o lugar onde a galera se encontra, troca ideia e sai ainda mais estilosa. Combinamos técnicas tradicionais com o que há de mais moderno no universo masculino.</p>
        ...
        <div class="container">
            ...
            <div class="galeria-grid">
                <div class="galeria-item">
                    <img src="/images/Templates/Barbearias/Estilo Urbano/corte1.jpeg" alt="Galeria 1">
                    <div class="galeria-overlay">
                        <h3>Corte Moderno</h3>
                    </div>
                </div>
                <div class="galeria-item">
                    <img src="/images/Templates/Barbearias/Estilo Urbano/barber2.webp" alt="Galeria 2">
                    <div class="galeria-overlay">
                        <h3>Ambiente Descontraído</h3>
                    </div>
                </div>
                <div class="galeria-item">
                    <img src="/images/Templates/Barbearias/Estilo Urbano/homem-com-barba.jpg" alt="Galeria 3">
                    <div class="galeria-overlay">
                        <h3>Equipe Profissional</h3>
                    </div>
                </div>
                <div class="galeria-item">
                    <img src="/images/Templates/Barbearias/Estilo Urbano/corte2.jpeg" alt="Galeria 4">
                    <div class="galeria-overlay">
                ...
                <div class="contato-info">
                    ...
                    <div class="contato-item">
                        ...
                        <div class="contato-text">
                            <h4>ONDE ESTAMOS</h4>
                            <p><?php echo e(tenant()->address ?? 'Rua da Juventude, 123 - Centro<br>São Paulo, SP'); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="contato-item">
                        ...
                        <div class="contato-text">
                            ...
                            <p><?php echo e(tenant()->phone ?? '(11) 99999-9999'); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="contato-item">
                        ...
                        <div class="contato-text">
                            <h4>E-MAIL</h4>
                            <p><?php echo e(tenant()->email ?? 'contato@barbeariaurbana.com'); ?></p>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-col">
                    <h4><?php echo e(tenant()->fantasy_name ?? 'BARBEARIA URBANA'); ?></h4>
                    ...
                    <div style="margin-top: 10px; color: #b0b0b0; font-size: 1rem;">
                        <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', tenant()->phone ?? '11999999999')); ?>" target="_blank" style="color: #b0b0b0; text-decoration: none;">
                            <i class="fab fa-whatsapp" style="margin-right: 6px;"></i><?php echo e(tenant()->phone); ?>
            ...
            <div class="footer-bottom">
                <p>&copy; 2023 <?php echo e(tenant()->fantasy_name ?? 'BARBEARIA URBANA'); ?>. FEITO COM ❤️ PELA GALERA QUE ENTENDE DE ESTILO.</p>
            </div>
        </div>
    </footer>
...
</html><?php /**PATH /var/www/pagby/resources/Templates/Barbearias/Estilo Urbano/home.blade.php ENDPATH**/ ?>