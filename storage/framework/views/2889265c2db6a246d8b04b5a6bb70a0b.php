    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-lg text-gray-600">
                Configure sua plataforma em <?php echo e($totalSteps); ?> passos simples
            </p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
            <div class="flex items-center justify-between mb-2">
                ...
                <span class="text-sm font-semibold text-indigo-600"><?php echo e($completedSteps); ?>/<?php echo e($totalSteps); ?> concluídos</span>
            </div>
            ...
            <div class="mt-2 text-center">
                <span class="text-2xl font-bold text-indigo-600"><?php echo e(number_format($progressPercentage, 0)); ?>%</span>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 overflow-hidden border-2 <?php echo e($step['completed'] ? 'border-green-500' : 'border-gray-200'); ?>">
                    <!-- Step Header -->
                    <div class="bg-gradient-to-r <?php echo e($step['completed'] ? 'from-green-500 to-green-600' : 'from-gray-500 to-gray-600'); ?> text-white p-4">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-3">
                                <span class="text-3xl"><?php echo e($step['icon']); ?></span>
                                <div>
                                    <div class="text-sm opacity-90">Passo <?php echo e($step['number']); ?></div>
                                    <h3 class="font-bold text-lg"><?php echo e($step['title']); ?></h3>
                                </div>
                            </div>
                    ...
                    <!-- Step Content -->
                    <div class="p-6">
                        <p class="text-gray-600 mb-4"><?php echo e($step['description']); ?></p>
                        ...
                        <a href="<?php echo e($step['route']); ?>" 
                           class="inline-flex items-center justify-center w-full px-4 py-3 <?php echo e($step['completed'] ? 'bg-gray-100 hover:bg-gray-200 text-gray-700' : 'bg-indigo-600 hover:bg-indigo-700 text-white'); ?> font-medium rounded-lg transition-colors duration-200">
                            <?php echo e($step['completed'] ? 'Revisar' : 'Configurar Agora'); ?>
        ...
        <!-- Completion Message -->
        <?php if($completedSteps === $totalSteps): ?>
...
<?php /**PATH /var/www/pagby/resources/views/livewire/proprietario/onboarding.blade.php ENDPATH**/ ?>