<div>
    <?php if($mostrarSugestoes && count($produtosSugeridos) > 0): ?>
        <div class="mt-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 border-2 border-blue-200 shadow-lg">
            ...
            <div class="space-y-3">
                <?php $__currentLoopData = $produtosSugeridos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="flex-1">
                                <div class="flex items-center gap-2 mb-1">
                                    ...
                                    <div class="flex-shrink-0 w-6 h-6 rounded border-2 flex items-center justify-center
                                        ...
                                        <?php if($this->isProdutoSelecionado($produto['id'])): ?>
...
<?php /**PATH /var/www/pagby/resources/views/livewire/cliente/sugestoes-produtos.blade.php ENDPATH**/ ?>