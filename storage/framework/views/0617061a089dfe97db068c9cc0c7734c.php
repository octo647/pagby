...
<?php if($messages): ?>
    <div <?php echo e($attributes->merge(['class' => 'bg-red-50 border border-red-200 rounded-md p-3 mt-2'])); ?>>
        <div class="flex">
...
<?php endif; ?>
<?php /**PATH /var/www/pagby/resources/views/components/password-error.blade.php ENDPATH**/ ?>