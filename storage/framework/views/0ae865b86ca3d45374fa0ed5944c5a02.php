                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $clientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cliente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="border-t hover:bg-gray-50">
                            <td class="px-4 py-3 font-medium text-gray-900"><?php echo e($cliente->name); ?></td>
                            <td class="px-4 py-3 text-gray-600"><?php echo e($cliente->email); ?></td>
                            <td class="px-4 py-3 text-center">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                    <?php echo e($cliente->total_agendamentos); ?>

                                </span>
                            </td>
                            <td class="px-4 py-3 text-right font-semibold text-green-600">
                                R$ <?php echo e(number_format($cliente->total_gasto, 2, ',', '.')); ?>

                            </td>
                            <td class="px-4 py-3 text-right">
                                <span class="text-lg font-bold text-purple-600">
                                    R$ <?php echo e(number_format($cliente->ticket_medio, 2, ',', '.')); ?>
            ...
            <div class="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                ...
                <div class="flex justify-between items-start mb-3">
                    <div class="flex-1 min-w-0">
                        <div class="font-medium text-gray-900 truncate"><?php echo e($cliente->name); ?></div>
                        <div class="text-sm text-gray-600 truncate"><?php echo e($cliente->email); ?></div>
                    </div>
                    <div class="ml-3 flex-shrink-0">
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                            <?php echo e($cliente->total_agendamentos); ?> agendamentos
                        </span>
                    </div>
                </div>
                ...
                <div class="mt-3 pt-3 border-t border-gray-100">
                    <div class="flex items-center justify-between text-xs text-gray-500">
                        ...
                        <span class="font-medium text-purple-600">
                            <?php echo e(number_format($cliente->ticket_medio, 0)); ?> reais
                        </span>
                    </div>
                    <div class="mt-1 bg-gray-200 rounded-full h-2">
                        <div class="bg-gradient-to-r from-purple-400 to-purple-600 h-2 rounded-full" 
                             style="width: <?php echo e(min(($cliente->ticket_medio / 200) * 100, 100)); ?>%"></div>
                    </div>
                </div>
            </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php /**PATH /var/www/pagby/resources/views/livewire/proprietario/ticket-medio.blade.php ENDPATH**/ ?>