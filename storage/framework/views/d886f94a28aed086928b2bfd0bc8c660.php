<div x-data="{ showEditPanel: <?php if ((object) ('showEditPanel') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showEditPanel'->value()); ?>')<?php echo e('showEditPanel'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showEditPanel'); ?>')<?php endif; ?> }">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-4 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <span class="text-sm text-gray-500"><?php echo e(count($officehours)); ?> funcionários</span>
                    </div>
                </div>
            </div>
            ...
            <div class="divide-y divide-gray-200">
                <?php $__empty_1 = true; $__currentLoopData = $officehours; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $officehour): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div wire:key="schedule-<?php echo e($index); ?>" class="p-6 hover:bg-gray-50 transition-colors">
                        <div class="flex flex-col lg:flex-row lg:items-center justify-between">
                            
                            
                            <div class="flex items-center space-x-4 mb-4 lg:mb-0">
                                <div class="flex-shrink-0">
                                    <?php if(!empty($officehour['photo'])): ?>
                                        <img src="<?php echo e(tenant_asset('profile-photos/' . basename($officehour['photo']))); ?>" 
                                             alt="<?php echo e($officehour['funcionario']); ?>" 
                                    ...
                                    <?php else: ?>
                                        <div class="h-12 w-12 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 flex items-center justify-center">
                                            <span class="text-lg font-medium text-white uppercase">
                                                <?php echo e(substr($officehour['funcionario'], 0, 2)); ?>
                                ...
                                <div>
                                    <h3 class="text-lg font-medium text-gray-900"><?php echo e($officehour['funcionario']); ?></h3>
                            ...
                            <div class="flex-1 lg:mx-6">
                                <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-2">
                                    <?php $__currentLoopData = ['seg' => 'Seg', 'ter' => 'Ter', 'qua' => 'Qua', 'qui' => 'Qui', 'sex' => 'Sex', 'sab' => 'Sáb', 'dom' => 'Dom']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dia => $diaAbrev): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        ...
                                        <div class="text-center">
                                            <div class="text-xs font-medium text-gray-600 mb-1"><?php echo e($diaAbrev); ?></div>
                                            <?php if($isWorking): ?>
                                                <div class="bg-green-100 border border-green-200 rounded-lg p-2">
                                                    <div class="text-xs font-medium text-green-800">
                                                        <?php echo e($ini); ?>-<?php echo e($fim); ?>

                                                    </div>
                                                    <?php if($lunch_ini && $lunch_fim): ?>
                                                        <div class="text-xs text-green-600 mt-1">
                                                            Almoço: <?php echo e($lunch_ini); ?>-<?php echo e($lunch_fim); ?>
                            ...
                            <div class="mt-4 lg:mt-0">
                                <button wire:click="abrirPainelEdicao(<?php echo e($index); ?>)" 
                ...
                <div x-show="showEditPanel"
                    ...
                    <div class="bg-gradient-to-r from-blue-600 to-purple-600 px-6 py-4 text-white">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-3">
                                ...
                                <?php if(!empty($editOfficehour['photo'])): ?>
                                    <img src="<?php echo e(tenant_asset('profile-photos/' . basename($editOfficehour['photo']))); ?>" 
                                         alt="<?php echo e($editOfficehour['funcionario'] ?? ''); ?>" 
                                ...
                                <?php else: ?>
                                    <div class="h-12 w-12 rounded-full bg-white bg-opacity-20 flex items-center justify-center border-2 border-white">
                                        <span class="text-lg font-medium text-white uppercase">
                                            <?php echo e(isset($editOfficehour['funcionario']) ? substr($editOfficehour['funcionario'], 0, 2) : ''); ?>
                                ...
                                <div>
                                    ...
                                    <p class="text-blue-100 text-sm mt-1"><?php echo e($editOfficehour['funcionario'] ?? ''); ?></p>
                                </div>
                            </div>
                    ...
                    <div class="flex-1 overflow-y-auto p-6">
                        ...
                        <div class="space-y-6">
                            ...
                            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dia => $config): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                    <div class="flex items-center justify-between mb-4">
                                        <h3 class="text-sm font-medium text-gray-900 flex items-center m-0">
                                            <div class="w-3 h-3 rounded-full bg-<?php echo e($config['cor']); ?>-500 mr-2"></div>
                                            <?php echo e($config['nome']); ?>

                                        </h3>
                                        <button type="button"
                                            wire:click="limparHorariosDia('<?php echo e($dia); ?>')"
                                        ...
                                        <div class="space-y-3">
                                            ...
                                            <div class="grid grid-cols-2 gap-2">
                                                <div>
                                                    ...
                                                    <input type="time" 
                                                           wire:model="editOfficehour.<?php echo e($dia); ?>_ini" 
                                                           class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                                </div>
                                                <div>
                                                    <label class="block text-xs text-gray-500 mb-1">Fim</label>
                                                    <input type="time" 
                                                           wire:model="editOfficehour.<?php echo e($dia); ?>_fim" 
                                                           class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="space-y-3">
                                            ...
                                            <div class="grid grid-cols-2 gap-2">
                                                <div>
                                                    <label class="block text-xs text-gray-500 mb-1">Início</label>
                                                    <input type="time" 
                                                           wire:model="editOfficehour.<?php echo e($dia); ?>_lunch_ini" 
                                                           class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                                </div>
                                                <div>
                                                    <label class="block text-xs text-gray-500 mb-1">Fim</label>
                                                    <input type="time" 
                                                           wire:model="editOfficehour.<?php echo e($dia); ?>_lunch_fim" 
                                                           class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                                </div>
                                            </div>
                                        </div>
...
<?php /**PATH /var/www/pagby/resources/views/livewire/proprietario/salon-times.blade.php ENDPATH**/ ?>