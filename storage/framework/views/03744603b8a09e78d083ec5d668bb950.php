<div>
    <?php if($mostrarRecompensas && count($recompensasAtivas) > 0): ?>
        <div class="mb-6 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-6 border-2 border-purple-200 shadow-lg">
            ...
            <div class="flex items-center gap-3 mb-4">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-sm text-gray-600">
                        Você tem <?php echo e(count($recompensasAtivas)); ?> recompensa(s) disponível(is). Clique para usar!
                    </p>
                </div>
            </div>
            ...
            <div class="space-y-3">
                <?php $__currentLoopData = $recompensasAtivas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recompensa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div wire:click="selecionarRecompensa(<?php echo e($recompensa['id']); ?>)" 
                            ...
                            <div class="flex-1">
                                <div class="flex items-center gap-2 mb-2">
                                    ...
                                    <span class="inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-semibold border
                                                 <?php echo e($this->getTipoBadgeClass($recompensa['tipo'])); ?>">
                                        <?php echo e($this->getTipoIcon($recompensa['tipo'])); ?>

                                        <?php echo e($this->getTipoLabel($recompensa['tipo'])); ?>
                                ...
                                <div class="ml-8">
                                    ...
                                    <?php elseif($recompensa['tipo'] === 'cupom'): ?>
                                        <p class="text-lg font-bold text-purple-600">
                                            <?php echo e($recompensa['percentual_desconto']); ?>% DE DESCONTO
                                        </p>
                                        <p class="text-sm text-gray-600 font-mono">
                                            Código: <span class="font-bold"><?php echo e($recompensa['codigo_cupom']); ?></span>
                                        </p>
                                    ...
                                    <div class="flex items-center gap-4 mt-2 text-xs text-gray-500">
                                        ...
                                        <?php if($recompensa['origem']): ?>
                                            <span>🎁 De: <?php echo e($recompensa['origem']); ?></span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
...
<?php /**PATH /var/www/pagby/resources/views/livewire/cliente/minhas-recompensas.blade.php ENDPATH**/ ?>