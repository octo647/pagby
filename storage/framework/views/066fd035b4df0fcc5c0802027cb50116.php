            ...
            <div class="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-100">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-blue-600"><?php echo e(number_format($totalSolicitacoes)); ?></p>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-100">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-indigo-600"><?php echo e($totalServicos); ?></p>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-100">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-lg font-bold text-green-600 truncate"><?php echo e($servicoMaisPopular ?? 'N/A'); ?></p>
                        <p class="text-sm text-slate-500 mt-1"><?php echo e($rankingServicos[$servicoMaisPopular] ?? 0); ?> solicitações</p>
                    </div>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-100">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-purple-600"><?php echo e($mediaSolicitacoes); ?></p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 bg-white rounded-2xl p-6 shadow-lg border border-slate-100">
                ...
                <?php else: ?>
                    ...
                    <div class="space-y-4">
                        <?php $__currentLoopData = $rankingServicos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $position => $servico): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <div class="group relative bg-gradient-to-r from-white to-slate-50 rounded-xl p-4 border <?php echo e($cor['border']); ?> hover:shadow-md transition-all duration-300">
                                <div class="flex items-center space-x-4">
                                    
                                    <div class="flex-shrink-0">
                                        <?php if($posicao <= 3): ?>
                                            <div class="w-12 h-12 bg-gradient-to-br <?php echo e($cor['bg']); ?> rounded-full flex items-center justify-center shadow-lg">
                                                <?php if($posicao == 1): ?>
                                        ...
                                        <?php else: ?>
                                            <div class="w-12 h-12 bg-gradient-to-br from-slate-200 to-slate-300 rounded-full flex items-center justify-center">
                                                <span class="text-slate-600 font-bold"><?php echo e($posicao); ?></span>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <div class="flex items-center justify-between mb-2">
                                            <h4 class="text-lg font-semibold text-slate-900 truncate"><?php echo e($position); ?></h4>
                                            <div class="flex items-center space-x-3">
                                                <span class="text-2xl font-bold <?php echo e($cor['text']); ?>"><?php echo e($servico); ?></span>
                                        ...
                                        <div class="w-full bg-slate-200 rounded-full h-2">
                                            <div class="bg-gradient-to-r <?php echo e($cor['bg']); ?> h-2 rounded-full transition-all duration-500 group-hover:shadow-md" 
                                                 style="width: <?php echo e($percentual); ?>%"></div>
                                        </div>
                                        
                                        <div class="flex justify-between items-center mt-2 text-xs text-slate-500">
                                            <span><?php echo e($servico); ?> solicitações</span>
                                            <?php if($posicao <= 3): ?>
                                                <span class="font-medium <?php echo e($cor['text']); ?>">
                                                    <?php if($posicao == 1): ?> 🥇 Líder
                                                    <?php elseif($posicao == 2): ?> 🥈 Vice-líder  
                                                    <?php else: ?> 🥉 3º Lugar
                                                    <?php endif; ?>
                                                </span>
                                            <?php endif; ?>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-lg border border-slate-100">
                ...
                <?php if(!empty($rankingServicos)): ?>
                    ...
                    <div class="space-y-2 max-h-32 overflow-y-auto">
                        <?php $__currentLoopData = array_slice($rankingServicos, 0, 5, true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $servico => $total): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center justify-between text-sm">
                                <div class="flex items-center space-x-2">
                                    <div class="w-3 h-3 rounded-full" style="background-color: <?php echo e(['#4F46E5', '#7C3AED', '#EC4899', '#EF4444', '#F59E0B'][$loop->index]); ?>"></div>
                                    <span class="text-slate-700 truncate max-w-24"><?php echo e(Str::limit($servico, 15)); ?></span>
                                </div>
                                <span class="text-slate-500 font-medium"><?php echo e($total); ?></span>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        
                        <?php if(count($rankingServicos) > 5): ?>
                            <div class="flex items-center justify-between text-sm">
                                <div class="flex items-center space-x-2">
                                    <div class="w-3 h-3 rounded-full bg-gray-400"></div>
                                    <span class="text-slate-700">Outros</span>
                                </div>
                                <span class="text-slate-500 font-medium"><?php echo e(array_sum(array_slice($rankingServicos, 5))); ?></span>
                            </div>
                        <?php endif; ?>
                    </div>
                <?php else: ?>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-500">Base: <?php echo e(number_format($totalSolicitacoes)); ?> solicitações analisadas</p>
                    </div>
                </div>
                <div class="text-right">
                    <p class="text-xs text-slate-400">Atualizado em <?php echo e(now()->format('d/m/Y H:i')); ?></p>
                    <p class="text-xs text-slate-500">Top <?php echo e(count($rankingServicos)); ?> serviços</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            <?php if(!empty($rankingServicos)): ?>
                ...
                if (ctx) {
                    const data = <?php echo json_encode(array_values(array_slice($rankingServicos, 0, 5))) ?>;
                    const labels = <?php echo json_encode(array_keys(array_slice($rankingServicos, 0, 5))) ?>;
                    
                    // Se há mais de 5 serviços, agrupa o resto em "Outros"
                    <?php if(count($rankingServicos) > 5): ?>
                        data.push(<?php echo e(array_sum(array_slice($rankingServicos, 5))); ?>);
                        labels.push('Outros');
                    <?php endif; ?>
...
<?php /**PATH /var/www/pagby/resources/views/livewire/proprietario/ranking-servicos.blade.php ENDPATH**/ ?>