                    ...
                    <tbody class="bg-white divide-y divide-blue-50">
                        <?php $__currentLoopData = $servicos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $servico): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td class="px-4 py-2"><?php echo e($servico->service->service ?? '-'); ?></td>
                                <td class="px-4 py-2">R$ <?php echo e(number_format($servico->subtotal, 2, ',', '.')); ?></td>
                            </tr>
                        ...
                        <?php $__currentLoopData = $produtos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td class="px-4 py-2">R$ <?php echo e(number_format($produto->subtotal, 2, ',', '.')); ?></td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /var/www/pagby/resources/views/livewire/funcionario/servicos-avulsos.blade.php ENDPATH**/ ?>