                ...
                <div class="hidden md:block overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <?php $__currentLoopData = $historico; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agendamento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-gray-50 transition-colors duration-200">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <?php if($agendamento->avaliacao): ?>
                                            <div class="space-y-2">
                                                
                                                <div class="flex items-center space-x-1">
                                                    <?php for($i = 1; $i <= 5; $i++): ?>
                                                        <?php if($i <= $agendamento->avaliacao->avaliacao): ?>
                                                ...
                                                <?php if($agendamento->avaliacao->comentario): ?>
...
<?php /**PATH /var/www/pagby/resources/views/livewire/cliente/historico.blade.php ENDPATH**/ ?>