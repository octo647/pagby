    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 mb-8 flex flex-col md:flex-row gap-4 md:items-end">
            <div class="flex flex-col w-full">
                ...
                <select wire:model="selectedBranch" class="border border-blue-300 rounded-lg px-3 py-2 focus:ring focus:ring-blue-200 bg-white shadow-sm">
            ...
            <div class="flex flex-col w-full">
                ...
                <input type="date" wire:model="periodoInicio" class="border border-blue-300 rounded-lg px-3 py-2 focus:ring focus:ring-blue-200 bg-white shadow-sm">
            </div>
            <div class="flex flex-col w-full">
                <label class="font-semibold text-blue-700 mb-1">Período (fim)</label>
                <input type="date" wire:model="periodoFim" class="border border-blue-300 rounded-lg px-3 py-2 focus:ring focus:ring-blue-200 bg-white shadow-sm">
            </div>
            <div class="flex flex-col w-full">
                <label class="font-semibold text-blue-700 mb-1">Comissão da Filial</label>
                <input type="text" value="<?php echo e(number_format($comissao, 2, ',', '.')); ?>%" readonly class="border border-blue-300 rounded-lg px-3 py-2 bg-slate-100 text-blue-900 font-bold">
            </div>
        </div>
        <div class="bg-white rounded-xl shadow-lg p-6 mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div class="bg-blue-50 rounded-lg p-4 flex flex-col items-center">
                    ...
                    <span class="text-2xl font-bold text-blue-900">R$ <?php echo e(number_format($totalServicos, 2, ',', '.')); ?></span>
                </div>
                <div class="bg-blue-50 rounded-lg p-4 flex flex-col items-center">
                    <span class="text-sm text-blue-700 font-medium mb-1">Produtos Vendidos</span>
                    <span class="text-2xl font-bold text-blue-900">R$ <?php echo e(number_format($totalProdutos, 2, ',', '.')); ?></span>
                </div>
                <div class="bg-green-50 rounded-lg p-4 flex flex-col items-center">
                    ...
                    <span class="text-2xl font-bold text-green-900">R$ <?php echo e(number_format($totalReceber, 2, ',', '.')); ?></span>
                </div>
            </div>
                    ...
                    <tbody class="bg-white divide-y divide-blue-50">
                        <?php $__currentLoopData = $servicos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $servico): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td class="px-4 py-2"><?php echo e($servico->descricao ?? $servico->servico_nome ?? '-'); ?></td>
                                <td class="px-4 py-2">R$ <?php echo e(number_format($servico->valor, 2, ',', '.')); ?></td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php $__currentLoopData = $produtos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="px-4 py-2 text-blue-800 font-medium">Produto</td>
                                <td class="px-4 py-2"><?php echo e($produto->descricao ?? $produto->produto_nome ?? '-'); ?></td>
                                <td class="px-4 py-2">R$ <?php echo e(number_format($produto->valor, 2, ',', '.')); ?></td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php if(count($servicos) == 0 && count($produtos) == 0): ?>
                            <tr>
...
<?php /**PATH /var/www/pagby/resources/views/livewire/funcionario/controle-ganhos-avulsos.blade.php ENDPATH**/ ?>