<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="bg-white rounded-lg p-6 border-l-4 border-red-500 shadow-sm">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-red-600"><?php echo e($totalInadimplentes); ?></p>
                    </div>
            ...
            <div class="bg-white rounded-lg p-6 border-l-4 border-orange-500 shadow-sm">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-orange-600">R$ <?php echo e(number_format($totalDividaGeral, 2, ',', '.')); ?></p>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-lg font-bold text-blue-600">
                            <?php echo e($bloqueioAutomatico ? 'Ativado' : 'Desativado'); ?>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
            ...
            <?php if($clientesInadimplentes->count() > 0): ?>
                <div class="divide-y divide-gray-200">
                    <?php $__currentLoopData = $clientesInadimplentes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cliente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                                ...
                                <div class="flex-1">
                                    <div class="flex items-center gap-3 mb-2">
                                        ...
                                        <div>
                                            <h4 class="font-bold text-gray-900"><?php echo e($cliente->customer_name); ?></h4>
                                            <p class="text-sm text-gray-500"><?php echo e($cliente->customer_phone); ?></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
                                        <div>
                                            ...
                                            <p class="font-bold text-red-600"><?php echo e($cliente->total_pagamentos_atrasados); ?></p>
                                        </div>
                                        <div>
                                            <p class="text-xs text-gray-500">Total devido</p>
                                            <p class="font-bold text-red-600">R$ <?php echo e(number_format($cliente->total_divida, 2, ',', '.')); ?></p>
                                        </div>
                                        <div>
                                            <p class="text-xs text-gray-500">Primeiro vencimento</p>
                                            <p class="font-semibold text-gray-700">
                                                <?php echo e(\Carbon\Carbon::parse($cliente->primeiro_vencimento)->format('d/m/Y')); ?>
                                        ...
                                        <div>
                                            ...
                                            <p class="font-bold text-orange-600">
                                                <?php echo e(\Carbon\Carbon::parse($cliente->primeiro_vencimento)->diffInDays(now())); ?> dias
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="flex flex-col gap-2">
                                    <button wire:click="enviarLembrete(<?php echo e($cliente->customer_id); ?>)"
                                    ...
                                    <button wire:click="bloquearCliente(<?php echo e($cliente->customer_id); ?>)"
...
<?php /**PATH /var/www/pagby/resources/views/livewire/proprietario/clientes-inadimplentes.blade.php ENDPATH**/ ?>