...
<head>
    ...
    <title><?php echo e(tenant()->fantasy_name ?? 'Barbearia Amizade'); ?></title>
...
<body class="bg-gray-900 text-gray-100 min-h-screen flex flex-col">
    ...
    <nav class="sticky-nav w-full py-4 bg-gray-900 shadow z-50">
        <div class="container mx-auto flex items-center justify-between px-4">
            <div class="flex items-center gap-3">
                <img src="<?php echo e(tenant()->logo ?? asset('images/default-user.png')); ?>" alt="Logo do Salão <?php echo e(tenant()->fantasy_name ?? 'Barbearia Salon Dumont'); ?>" class="w-12 h-12 rounded-full object-cover border-2 border-yellow-600 shadow">
                <span class="text-2xl font-extrabold text-yellow-600 tracking-wide"><?php echo e(tenant()->fantasy_name ?? 'Barbearia Salon Dumont'); ?></span>
            </div>
            ...
            <div class="flex items-center gap-4">
                <a href="<?php echo e(route('login')); ?>" class="bg-yellow-600 text-gray-900 px-4 py-2 rounded-full text-sm font-bold shadow hover:bg-yellow-700 transition">Entrar</a>
                <a href="<?php echo e(route('register')); ?>" class="bg-yellow-600 text-gray-900 px-4 py-2 rounded-full text-sm font-bold shadow hover:bg-yellow-700 transition">Registrar</a>
            </div>
        </div>
    </nav>
    ...
    <main class="flex-1 flex flex-col items-center text-center px-4">
        ...
        <section id="servicos" class="mb-16 w-full max-w-6xl fade-in">
            ...
            <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $servico): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="service-card bg-gray-800 rounded-lg p-6 shadow-lg border border-gray-700 mb-6">
                    <div class="flex flex-col items-center">
                        <div class="w-20 h-20 mb-4 rounded-full overflow-hidden border-2 border-yellow-600 shadow">
                            <img src="<?php echo e(asset('/services/' . $servico->photo)); ?>" alt="<?php echo e($servico->service); ?>" class="w-full h-full object-cover"> 
                        </div>
                        
                        

                        <h3 class="text-xl font-bold text-yellow-400 mb-2"><?php echo e($servico->service); ?></h3>
                        <p class="text-gray-300 mb-4"><?php echo e($servico->description); ?></p>
                        <span class="text-yellow-500 font-bold">R$ <?php echo e(number_format($servico->price, 2, ',', '.')); ?></span>
                    </div>
                </div>
        ...
        <section id="sobre" class="mb-16 w-full max-w-4xl fade-in">
            ...
            <p class="text-gray-300 max-w-2xl mx-auto mb-6">Desde 2020 a <?php echo e(tenant()->fantasy_name ?? 'Barbearia Tradição'); ?> traz para nossos clientes as mais novas tendências e técnicas de cortes e barbas. Oferecemos serviços de alta qualidade em um ambiente familiar.</p>
        ...
        <section id="contato" class="mb-16 w-full max-w-4xl fade-in">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="bg-gray-800 rounded-lg p-6 shadow-lg border border-gray-700 text-left">
                    ...
                    <p class="text-gray-300 mb-2"><?php echo e(tenant()->address ?? 'Rua Exemplo, 123 - Centro'); ?></p>
                    
                    <h3 class="text-xl font-bold text-yellow-400 mt-6 mb-4">Telefone</h3>
                    <p class="text-gray-300"><?php echo e(tenant()->phone ?? '(11) 99999-9999'); ?></p>
                </div>
                ...
                <div class="bg-gray-800 rounded-lg p-6 shadow-lg border border-gray-700">
                    ...
                    <div class="flex gap-4 justify-center">
                        <a href="<?php echo e(tenant()->instagram ?? '#'); ?>" target="_blank" class="bg-yellow-600 text-gray-900 w-12 h-12 rounded-full flex items-center justify-center hover:bg-yellow-700 transition transform hover:scale-110">
                            <i class="fab fa-instagram text-xl"></i>
                        </a>
                        <a href="<?php echo e(tenant()->facebook ?? '#'); ?>" target="_blank" class="bg-yellow-600 text-gray-900 w-12 h-12 rounded-full flex items-center justify-center hover:bg-yellow-700 transition transform hover:scale-110">
                            <i class="fab fa-facebook text-xl"></i>
                        </a>
                        <a href="https://wa.me/<?php echo e(tenant()->whatsapp ?? '5511999999999'); ?>" target="_blank" class="bg-yellow-600 text-gray-900 w-12 h-12 rounded-full flex items-center justify-center hover:bg-yellow-700 transition transform hover:scale-110">
        ...
        <div class="container mx-auto text-center">
            <div class="flex flex-col md:flex-row justify-between items-center mb-6">
                <div class="flex items-center gap-3 mb-4 md:mb-0">
                    <img src="<?php echo e(tenant()->logo ?? asset('images/default-user.png')); ?>" alt="Logo do Salão <?php echo e(tenant()->fantasy_name ?? 'Barbearia Salon Dumont'); ?>" class="w-10 h-10 rounded-full object-cover border-2 border-yellow-600 shadow">
                    <span class="text-xl font-extrabold text-yellow-600 tracking-wide"><?php echo e(tenant()->fantasy_name ?? 'Barbearia Salon Dumont'); ?></span>
                </div>
            ...
            <div class="text-gray-400 text-sm">
                &copy; <?php echo e(date('Y')); ?> <?php echo e(tenant()->fantasy_name ?? 'Barbearia Salon Dumont'); ?>. Todos os direitos reservados.
            </div>
        </div>
    </footer>
...
<?php /**PATH /var/www/pagby/resources/Templates/Barbearias/Amizade/home.blade.php ENDPATH**/ ?>