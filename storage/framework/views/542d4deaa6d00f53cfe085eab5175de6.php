<div class="min-h-screen bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        ...
        <?php if(session()->has('assinatura-valida')): ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <?php if(auth()->guard()->check()): ?>
                <?php if(!empty($recompensasDisponiveis)): ?>
                    <div class="mb-6 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-5 border-2 border-purple-200 shadow-md">
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="space-y-2">
                                    <?php $__currentLoopData = $recompensasDisponiveis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recompensa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex items-center justify-between bg-white rounded-lg p-3 border border-purple-200">
                                            ...
                                            <?php if($recompensa['dias_restantes'] <= 7): ?>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-8 mb-8">
                ...
                <?php if(!empty($forward_days)): ?>
                    ...
                    <div class="grid grid-cols-3 sm:grid-cols-4 lg:grid-cols-7 gap-4 justify-items-center">
                        <?php $__currentLoopData = $forward_days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
            ...
            <?php if(isset($selected_day) && !empty($available_times[$selected_day])): ?>
                <div class="bg-white rounded-2xl shadow-lg p-8">
                    ...
                    <div class="grid grid-cols-3 sm:grid-cols-4 lg:grid-cols-6 gap-4 justify-items-center">
                        <?php if(!empty($available_times[$selected_day])): ?>
                            <?php $__currentLoopData = $available_times[$selected_day]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <button 
            ...
            <?php if(isset($selected_time) && $selected_time): ?>
                
                <?php if(auth()->guard()->check()): ?>
                    <?php if(!empty($recompensasAtivasCompletas)): ?>
                        <div class="mb-6 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-6 border-2 border-purple-200 shadow-lg">
                            ...
                            <div class="space-y-3">
                                <?php $__currentLoopData = $recompensasAtivasCompletas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $recompensa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="flex-1">
                                                <div class="flex items-center gap-2 mb-2">
                                                    ...
                                                    <div class="flex-shrink-0 w-6 h-6 rounded-full border-2 flex items-center justify-center
                                                        ...
                                                        <?php if(in_array($recompensa['id'], $recompensasSelecionadas)): ?>
                            ...
                            <?php if(count($recompensasSelecionadas) > 0): ?>
                                <?php
                ...
                <?php if($ch_professional && !empty($ch_services)): ?>
...
<?php /**PATH /var/www/pagby/resources/views/livewire/cliente/make-appointment.blade.php ENDPATH**/ ?>