<div>
    ...
    <?php if(session()->has('message') || session()->has('warning') || session()->has('error')): ?>
        <div class="mb-6">
            <div class="flex items-center p-4 text-sm <?php echo e(session()->has('error') ? 'text-red-800 bg-red-50 border-red-200' : 'text-green-800 bg-green-50 border-green-200'); ?> rounded-lg border" role="alert">
                ...
                <div>
                    <span class="font-medium"><?php echo e(session('message') ?? session('warning') ?? session('error')); ?></span>
                </div>
            </div>
        </div>
    <?php endif; ?>

<div x-data="{ showModal: <?php if ((object) ('showModal') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showModal'->value()); ?>')<?php echo e('showModal'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showModal'); ?>')<?php endif; ?> }" class="min-h-screen bg-gray-50">
                    ...
                    <div class="p-6 hover:bg-gray-50 transition-colors cursor-pointer"
                         ...
                         @click="
                            if (!($event.target.closest('button') || $event.target.closest('select') || $event.target.closest('input'))) {
                                $wire.showUserDetails(<?php echo e($user->id); ?>);
                            }
                         "
                    >
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                            ...
                            <div class="flex items-center space-x-3">
                                <div class="flex-shrink-0">
                                    <?php if($user->photo): ?>
                                        ...
                                        ?>
                                        <img src="<?php echo e($isExternal ? $user->photo : tenant_asset($user->photo)); ?>" 
                                    ...
                                    <div class="flex flex-col gap-1">
                                        ...
                                        <div class="flex flex-wrap gap-1 mt-1">
                                            <?php $__currentLoopData = $user->roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <span class="px-2 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800"><?php echo e($role->role); ?></span>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                    </div>
                                <?php endif; ?>
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <?php else: ?>
                                    <button wire:click.stop="editUser(<?php echo e($user->id); ?>)" 
        ...
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div x-show="showModal"
                ...
                <div class="flex items-center justify-between pb-4 border-b border-gray-200">
                    <div class="flex items-center space-x-3">
                        <div class="flex-shrink-0">
                            <?php if(isset($userDetails['photo']) && $userDetails['photo']): ?>
                                <?php
                                    $isExternal = Str::startsWith($userDetails['photo'], ['http://', 'https://']);
                                ?>
                                <img src="<?php echo e($isExternal ? $userDetails['photo'] : tenant_asset($userDetails['photo'])); ?>" 
                                     alt="<?php echo e($userDetails['nome'] ?? 'Usuário'); ?>"
                                     class="h-12 w-12 rounded-full object-cover border-2 border-gray-200">
                            <?php else: ?>
                                <div class="h-12 w-12 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 flex items-center justify-center">
                                    <span class="text-lg font-medium text-white uppercase">
                                        <?php if(isset($userDetails['nome'])): ?>
                                            <?php echo e(substr($userDetails['nome'], 0, 2)); ?>
                ...
                <div class="mt-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-gray-50 rounded-lg p-4">
                            ...
                            <div class="space-y-3">
                                <div class="flex justify-between">
                                    ...
                                    <span class="text-sm text-gray-900"><?php echo e($userDetails['nome'] ?? 'N/A'); ?></span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm font-medium text-gray-600">Email:</span>
                                    <span class="text-sm text-gray-900"><?php echo e($userDetails['email'] ?? 'N/A'); ?></span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm font-medium text-gray-600">WhatsApp:</span>
                                    <span class="text-sm text-gray-900"><?php echo e($userDetails['phone'] ?? 'N/A'); ?></span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm font-medium text-gray-600">Papéis:</span>
                                    <span class="flex flex-wrap gap-1">
                                        <?php if(isset($userDetails['funcoes']) && is_array($userDetails['funcoes']) && count($userDetails['funcoes'])): ?>
                                            <?php $__currentLoopData = $userDetails['funcoes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $funcao): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800"><?php echo e($funcao); ?></span>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php else: ?>
                        ...
                        <div class="bg-gray-50 rounded-lg p-4">
                            ...
                            <div class="space-y-3">
                                <div class="flex justify-between">
                                    ...
                                    <span class="text-sm text-gray-900"><?php echo e($userDetails['agendamentos'] ?? '0'); ?></span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm font-medium text-gray-600">Último:</span>
                                    <span class="text-sm text-gray-900"><?php echo e($userDetails['ultimo_agendamento'] ?? 'Nunca'); ?></span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm font-medium text-gray-600">Agendado:</span>
                                    <?php if($userDetails['tem_agendamento'] ?? false): ?>
                        ...
                        <div class="bg-gray-50 rounded-lg p-4 md:col-span-2">
                            ...
                            <?php if(isset($userDetails['plano']) && $userDetails['plano'] !== 'Nenhum plano ativo'): ?>
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div class="text-center">
                                        <span class="text-sm font-medium text-gray-600 block">Plano Atual</span>
                                        <span class="text-sm text-gray-900 mt-1 block"><?php echo e($userDetails['plano']); ?></span>
                                    </div>
                                    <div class="text-center">
                                        <span class="text-sm font-medium text-gray-600 block">Início</span>
                                        <span class="text-sm text-gray-900 mt-1 block"><?php echo e($userDetails['plano_inicio'] ?? 'N/A'); ?></span>
                                    </div>
                                    <div class="text-center">
                                        <span class="text-sm font-medium text-gray-600 block">Fim</span>
                                        <span class="text-sm text-gray-900 mt-1 block"><?php echo e($userDetails['plano_fim'] ?? 'N/A'); ?></span>
                                    </div>
                                </div>
                            <?php else: ?>
                                <div class="text-center py-4">
                                    <span class="text-sm text-gray-500"><?php echo e($userDetails['plano'] ?? 'Nenhum plano ativo'); ?></span>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
...
<?php /**PATH /var/www/pagby/resources/views/livewire/salon-users.blade.php ENDPATH**/ ?>