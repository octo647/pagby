...
<body>
            ...
            <div class="col-md-8">
                <div class="card shadow">
                    ...
                    <div class="card-body text-center">
                        <div class="mb-4">
                            <h6>Quase lá! 🎉</h6>
                            <p><strong><?php echo e($tenant_name); ?></strong> </p>
                            <p><strong>Plano:</strong> <?php echo e($plan_name); ?></p>
                            <p><strong>Valor:</strong> R$ <?php echo e(number_format($payment->amount, 2, ',', '.')); ?></p>
                        </div>
                        ...
                        <?php if($checkout_url && $checkout_url !== '#'): ?>
                        <div class="mt-4 mb-4" id="invoice-section">
                            <a href="<?php echo e($checkout_url); ?>" target="_blank" class="btn btn-success btn-lg">
                        ...
                        <div id="status-section">
                            ...
                            <div class="mt-3">
                                <small class="text-muted">
                                    Status atual: <span id="current-status" class="badge bg-info"><?php echo e(ucfirst($payment->status)); ?></span>
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="mt-4">
                            <a href="https://<?php echo e($tenant_id); ?>.pagby.com.br/dashboard?tabelaAtiva=planos-de-assinatura" class="btn btn-secondary">
    ...
    let invoiceUrl = '<?php echo e($checkout_url ?? ""); ?>';
    ...
    function fetchInvoiceUrl() {
        ...
        fetch('/tenant-assinatura/get-invoice/<?php echo e($payment->id); ?>')
    ...
    function checkPaymentStatus() {
        ...
        checkInterval = setInterval(() => {
            ...
            fetch('/tenant-assinatura/check-status/<?php echo e($payment->id); ?>?tenant_id=<?php echo e($tenant_id); ?>')
                ...
                .then(data => {
                    ...
                    if (data.status === 'approved' || data.status === 'authorized') {
                        ...
                        setTimeout(() => {
                            <?php if(isset($tenant_domain) && $tenant_domain): ?>
                            console.log('🌐 Redirecionando para domínio do tenant:', '<?php echo e($tenant_domain); ?>');
                            window.location.href = 'https://<?php echo e($tenant_domain); ?>/tenant-assinatura/success?payment_id=' + data.payment_id;
                            <?php else: ?>
...
</html><?php /**PATH /var/www/pagby/resources/views/tenant-assinatura/wait.blade.php ENDPATH**/ ?>