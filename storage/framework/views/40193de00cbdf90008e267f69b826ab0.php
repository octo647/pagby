            ...
            <div class="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-100">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-slate-900">R$ <?php echo e(number_format($faturamentoTotal, 2, ',', '.')); ?></p>
                        <p class="text-sm text-slate-500 mt-1"><?php echo e(count($faturamentoMensal)); ?> meses</p>
                    </div>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-100">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-blue-600">R$ <?php echo e(number_format($mediaMensal, 2, ',', '.')); ?></p>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-100">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-green-600">R$ <?php echo e(number_format($melhorMes, 2, ',', '.')); ?></p>
                        <?php if($melhorMesNome): ?>
                            <p class="text-sm text-slate-500 mt-1"><?php echo e(\Carbon\Carbon::createFromFormat('Y-m', $melhorMesNome)->format('m/Y')); ?></p>
                        <?php endif; ?>
                    </div>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-100">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-orange-600">R$ <?php echo e(number_format($piorMes, 2, ',', '.')); ?></p>
                        <?php
                            $variacao = $melhorMes > 0 && $piorMes > 0 ? (($melhorMes - $piorMes) / $piorMes) * 100 : 0;
                        ?>
                        <p class="text-sm text-slate-500 mt-1"><?php echo e(number_format($variacao, 1)); ?>% variação</p>
                    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 bg-white rounded-2xl p-6 shadow-lg border border-slate-100 hover:shadow-xl transition-all duration-300">
                ...
                <div class="flex flex-wrap items-center justify-between mt-4 pt-4 border-t border-slate-100">
                    ...
                    <div class="text-xs text-slate-400 flex items-center space-x-2">
                        ...
                        <span>Atualizado: <?php echo e(now()->format('d/m/Y H:i')); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-lg border border-slate-100">
                ...
                <div class="space-y-3 max-h-96 overflow-y-auto">
                    <?php $__currentLoopData = $faturamentoMensal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mes => $total): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            ...
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <div class="font-semibold text-slate-900">
                                        <?php echo e(\Carbon\Carbon::createFromFormat('Y-m', $mes)->locale('pt_BR')->isoFormat('MMM/YYYY')); ?>

                                    </div>
                                    <div class="text-xs text-slate-500">
                                        <?php echo e(number_format($porcentagemDoMelhor, 1)); ?>% do pico
                                    </div>
                                </div>
                            </div>
                            <div class="text-right">
                                <div class="font-bold text-slate-900">
                                    R$ <?php echo e(number_format($total, 0, ',', '.')); ?>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Dados do gráfico
        const labels = <?php echo json_encode(array_map(fn($m) => \Carbon\Carbon::createFromFormat('Y-m', $m)->locale('pt_BR')->isoFormat('MMM/YY'), array_keys($faturamentoMensal))); ?>;
        const data = <?php echo json_encode(array_values($faturamentoMensal)); ?>;
...
<?php /**PATH /var/www/pagby/resources/views/livewire/proprietario/faturamento-mensal.blade.php ENDPATH**/ ?>