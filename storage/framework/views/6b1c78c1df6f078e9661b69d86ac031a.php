<div class="min-h-screen bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        ...
        ?>
        <!--[if BLOCK]><![endif]--><?php if(count($agendamentosFiltrados)>0): ?>
            
            <div class="space-y-6">

                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $agendamentosFiltrados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$schedule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                        ...
                        <div class="bg-gradient-to-r from-blue-500 to-purple-600 px-6 py-4">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <h3 class="text-lg font-semibold text-white">Agendamento #<?php echo e($index + 1); ?></h3>
                                        <p class="text-blue-100 text-sm"><?php echo e($schedule['date']); ?> às <?php echo e($schedule['start_time']); ?></p>
                                    </div>
                                </div>
                                <div class="text-right">
                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium
                                        <?php if($schedule['status'] === 'Confirmado'): ?> bg-green-100 text-green-800
                                        <?php elseif($schedule['status'] === 'Pendente'): ?> bg-yellow-100 text-yellow-800  
                                        <?php elseif($schedule['status'] === 'Cancelado'): ?> bg-red-100 text-red-800
                                        <?php else: ?> bg-gray-100 text-gray-800 <?php endif; ?>">
                                        <!--[if BLOCK]><![endif]--><?php if($schedule['status'] === 'Confirmado'): ?> ✅
                                        <?php elseif($schedule['status'] === 'Pendente'): ?> ⏳
                                        <?php elseif($schedule['status'] === 'Cancelado'): ?> ❌
                                        <?php else: ?> 📋 <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="p-6">
                                ...
                                <div class="space-y-4">
                                    <div class="flex items-start space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-900"><?php echo e($schedule['branch']); ?></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-start space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-900"><?php echo e($schedule['professional']); ?></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="space-y-4">
                                    <div class="flex items-start space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-900"><?php echo e($schedule['services']); ?></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-start space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-900 font-semibold"><?php echo e($schedule['total']); ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            ?>
                            <!--[if BLOCK]><![endif]--><?php if($comandas && count($comandas) > 0): ?>
                                <div class="mt-6" x-data="{ mostrarComandas: false }">
                                    ...
                                    <button @click="mostrarComandas = !mostrarComandas" 
                                        ...
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <span class="text-sm font-semibold text-gray-700">Comandas Relacionadas (<?php echo e(count($comandas)); ?>)</span>
                                        </div>
                                    ...
                                    <div x-show="mostrarComandas" 
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $comandas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comanda): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="flex justify-between items-center bg-white p-3 rounded-lg border <?php echo e($temDiscrepancia ? 'border-yellow-300 bg-yellow-50' : 'border-gray-100'); ?>">
                                                <div class="flex items-center space-x-3">
                                                    <div class="w-8 h-8 <?php echo e($temDiscrepancia ? 'bg-yellow-100' : 'bg-blue-100'); ?> rounded-full flex items-center justify-center">
                                                        <svg class="w-4 h-4 <?php echo e($temDiscrepancia ? 'text-yellow-600' : 'text-blue-600'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                                        </svg>
                                                    </div>
                                                    <div>
                                                        <div class="flex items-center space-x-2">
                                                            <p class="text-sm font-medium text-gray-900">Comanda #<?php echo e($comanda->numero_comanda); ?></p>
                                                            <!--[if BLOCK]><![endif]--><?php if($temDiscrepancia): ?>
                                                        ...
                                                        <div class="text-xs space-y-1">
                                                            <p class="text-gray-500">R$ <?php echo e(number_format($comanda->total_geral, 2, ',', '.')); ?></p>
                                                            <!--[if BLOCK]><![endif]--><?php if($temDiscrepancia): ?>
                                                                <p class="text-yellow-600 font-medium">
                                                                    ⚠️ Preço atualizado (Era: R$ <?php echo e($schedule['total']); ?>)
                                                                </p>
                                                ...
                                                <div class="flex flex-col items-end space-y-1">
                                                    <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium
                                                        <?php if($comanda->status === 'Aberta'): ?> bg-blue-100 text-blue-800
                                                        <?php elseif($comanda->status === 'Finalizada'): ?> bg-green-100 text-green-800
                                                        <?php elseif($comanda->status === 'Cancelada'): ?> bg-red-100 text-red-800
                                                        <?php else: ?> bg-gray-100 text-gray-800 <?php endif; ?>">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($algumTemDiscrepancia): ?>
                        ...
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($schedule['status'] !== 'Cancelado'): ?>
                                <?php
                                ...
                                <div class="px-6 py-4 bg-gray-50 border-t border-gray-100">
                                    <div class="flex justify-end">
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($hoje && $diffMinutos < 0): ?>
                                            <!--[if BLOCK]><![endif]--><?php if($diffMinutos < -120): ?>
                                                <div class="text-left w-full text-sm text-gray-700 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                                                    Se precisar cancelar este agendamento, por favor entre em contato com o Profissional <span class="font-semibold"><?php echo e($schedule['professional']); ?></span>
                                                    <!--[if BLOCK]><![endif]--><?php if(!empty($schedule['professional_phone'])): ?>
                                                        através do whatsapp <a href="https://wa.me/<?php echo e($schedule['professional_phone']); ?>" class="text-blue-600 underline"><?php echo e($schedule['professional_phone']); ?></a>
                                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                                    com pelo menos duas horas de antecedência.
                                                </div>
                                            <?php else: ?>
                                                <div class="text-left w-full text-sm text-gray-700 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                                                    Se precisar adiar ou cancelar este agendamento, fale com <span class="font-semibold"><?php echo e($schedule['professional']); ?></span>
                                                    <!--[if BLOCK]><![endif]--><?php if(!empty($schedule['professional_phone'])): ?>
                                                        através do whatsapp <a href="https://wa.me/<?php echo e($schedule['professional_phone']); ?>" class="text-blue-600 underline"><?php echo e($schedule['professional_phone']); ?></a>
                                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                                    . 
...
<?php /**PATH /home/helder/projetos/pagby/resources/views/livewire/cliente/appointments.blade.php ENDPATH**/ ?>