                    ...
                    <tr>
                        <td style="background: linear-gradient(135deg, #ec4899 0%, #8b5cf6 100%); padding: 40px 30px; text-align: center;">
                            <h1 style="margin: 0; color: #ffffff; font-size: 28px; font-weight: bold;">
                                🎉 Parabéns, <?php echo e($contact->owner_name); ?>!
                            </h1>
                            <p style="margin: 10px 0 0 0; color: #ffffff; font-size: 16px;">
                                Seu salão <strong><?php echo e($tenant->fantasy_name); ?></strong> está no ar!
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            <p style="margin: 0 0 20px 0; font-size: 16px; line-height: 1.6; color: #333333;">
                                Olá, <strong><?php echo e($contact->owner_name); ?></strong>!
                            </p>
                                ...
                                <table width="100%" cellpadding="10" cellspacing="0">
                                    <tr>
                                        ...
                                        <td style="font-size: 16px; color: #1e293b; word-break: break-all;">
                                            <strong><?php echo e($contact->email); ?></strong>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 100px; font-weight: bold; color: #4338ca; font-size: 14px; vertical-align: top;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size: 14px; color: #1e293b; word-break: break-all;">
                                            <a href="<?php echo e($loginUrl); ?>" style="color: #4338ca; text-decoration: none;">
                                                <?php echo e($loginUrl); ?>
                    ...
                    <tr>
                        <td style="background-color: #f9fafb; padding: 20px 30px; text-align: center; border-top: 1px solid #e5e7eb;">
                            <p style="margin: 0; font-size: 12px; color: #9ca3af;">
                                © <?php echo e(date('Y')); ?> PagBy - Sistema de Gerenciamento para Salões e Barbearias
                            </p>
...
<?php /**PATH /var/www/pagby/resources/views/emails/tenant-owner-credentials.blade.php ENDPATH**/ ?>