    ...
    <div class="max-w-md w-full">
            ...
            <div class="p-6">
                ...
                <div class="bg-gray-50 rounded-lg p-4 mb-6">
                    ...
                    <div class="space-y-2">
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium"><?php echo e($description); ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Checkout ID:</span>
                            <span class="font-mono text-sm bg-gray-200 px-2 py-1 rounded"><?php echo e($checkout_id); ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Status:</span>
                            <span class="font-semibold text-green-600"><?php echo e(ucfirst($status)); ?></span>
                        </div>
                        <div class="border-t border-gray-300 pt-2 mt-2">
                            <div class="flex justify-between text-lg font-bold">
                                <span>Total:</span>
                                <span class="text-blue-600">R$ <?php echo e(number_format($amount, 2, ',', '.')); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-3">
                    <button onclick="simulatePayment()" 
                        ...
                        <i class="fas fa-lock mr-2"></i>Pagar R$ <?php echo e(number_format($amount, 2, ',', '.')); ?>

                    </button>
                    
                    <a href="<?php echo e(route('pagby-subscription.success')); ?>?checkout_id=<?php echo e($checkout_id); ?>" 
        ...
        <div class="mt-4 text-center">
            <div class="inline-flex items-center bg-gray-800 text-white px-4 py-2 rounded-lg">
                ...
                <span class="font-mono text-sm">ID: <?php echo e($checkout_id); ?></span>
            </div>
        </div>
    </div>
    ...
    <script>
        function simulatePayment() {
            ...
            setTimeout(() => {
                ...
                window.location.href = "<?php echo e(route('pagby-subscription.success')); ?>?checkout_id=<?php echo e($checkout_id); ?>&amount=<?php echo e($amount); ?>";
            }, 1500);
        }
        
        // Log no console para desenvolvedores
        console.log('Asaas Mock Checkout:', {
            id: "<?php echo e($checkout_id); ?>",
...
<?php /**PATH /var/www/pagby/resources/views/asaas-mock/checkout.blade.php ENDPATH**/ ?>