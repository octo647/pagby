<div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div>
                    ...
                    <select wire:model.live="mes_selecionado" id="mes_selecionado" 
                        ...
                        <?php $__currentLoopData = $mesesDisponiveis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            ?>
                            <option value="<?php echo e($mes); ?>"><?php echo e($mesFormatado); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-slate-100 mb-8">
                <div class="bg-gradient-to-r from-indigo-600 to-purple-700 text-white px-6 py-4 rounded-t-2xl">
                    <div class="flex items-center">
                        ...
                        <h3 class="text-xl font-bold"><?php echo e($tituloMes); ?></h3>
                    </div>
                </div>
                
                <?php if($dias->isNotEmpty()): ?>
                    <!-- Tabela Desktop -->
                                ...
                                <?php $__currentLoopData = $dias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr class="hover:bg-slate-50 transition-colors duration-200">
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <div>
                                                    <div class="text-sm font-semibold text-slate-900">
                                                        <?php echo e(\Carbon\Carbon::parse($dia['data'])->format('d/m/Y')); ?>

                                                    </div>
                                                    <div class="text-xs text-slate-500">
                                                        <?php echo e(\Carbon\Carbon::parse($dia['data'])->locale('pt_BR')->dayName); ?>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right">
                                            <div class="text-sm font-semibold text-slate-900">
                                                R$ <?php echo e(number_format($dia['entrada_esperada'], 2, ',', '.')); ?>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right">
                                            <div class="text-sm font-semibold text-slate-900">
                                                R$ <?php echo e(number_format($dia['entrada_caixa'], 2, ',', '.')); ?>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            <?php if($diferenca > 0): ?>
                                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold bg-green-100 text-green-800">
                                                    ...
                                                    +R$ <?php echo e($diferencaFormatada); ?>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            <button wire:click.prevent="abrirPainelEdicao('<?php echo e($dia['data']); ?>')"
                            ...
                            <div class="bg-slate-50 rounded-xl p-4 border border-slate-200">
                                ...
                                <div class="grid grid-cols-2 gap-3 mb-3">
                                    <div>
                                        ...
                                        <div class="text-sm font-semibold text-slate-900">R$ <?php echo e(number_format($dia['entrada_esperada'], 2, ',', '.')); ?></div>
                                    </div>
                                    <div>
                                        <div class="text-xs text-slate-500 uppercase font-medium">Registrado</div>
                                        <div class="text-sm font-semibold text-slate-900">R$ <?php echo e(number_format($dia['entrada_caixa'], 2, ',', '.')); ?></div>
                                    </div>
                                </div>
        ...
        <?php else: ?>
            <!-- Todos os Meses -->
            <?php $__empty_1 = true; $__currentLoopData = $diasPorMes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mes => $dias): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php $tituloMes = ucfirst(\Carbon\Carbon::parse($mes.'-01')->locale('pt_BR')->isoFormat('MMMM/YYYY')); ?>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-slate-100 mb-6">
                    <div class="bg-gradient-to-r from-indigo-600 to-purple-700 text-white px-6 py-4 rounded-t-2xl">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-sm text-indigo-100"><?php echo e(count($dias)); ?> discrepância(s)</div>
                        </div>
                    </div>
                            ...
                            <div class="bg-slate-50 rounded-xl p-4 border border-slate-200">
                                <div class="flex items-center justify-between mb-3">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <div class="font-medium text-slate-900"><?php echo e(\Carbon\Carbon::parse($dia['data'])->format('d/m/Y')); ?></div>
                                            <div class="text-xs text-slate-500"><?php echo e(\Carbon\Carbon::parse($dia['data'])->locale('pt_BR')->dayName); ?></div>
                                        </div>
                                    </div>
                                    <?php if($diferenca > 0): ?>
                                        <span class="text-xs font-semibold text-green-600">+R$ <?php echo e($diferencaFormatada); ?></span>
                                    <?php else: ?>
                                        <span class="text-xs font-semibold text-red-600">-R$ <?php echo e($diferencaFormatada); ?></span>
                                    <?php endif; ?>
                                </div>
                                
                                <div class="grid grid-cols-2 gap-3 mb-3 text-xs">
                                    <div>
                                        <span class="text-slate-500">Esperado:</span> R$ <?php echo e(number_format($dia['entrada_esperada'], 2, ',', '.')); ?>

                                    </div>
                                    <div>
                                        <span class="text-slate-500">Caixa:</span> R$ <?php echo e(number_format($dia['entrada_caixa'], 2, ',', '.')); ?>
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-indigo-100 text-sm">
                                <?php echo e(\Carbon\Carbon::parse($dataEdicao)->format('d/m/Y')); ?> - <?php echo e(\Carbon\Carbon::parse($dataEdicao)->locale('pt_BR')->dayName); ?>
                        ...
                        <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-200">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div class="bg-white rounded-xl p-4 border border-blue-100">
                                    ...
                                    <div class="text-lg font-bold text-slate-900">R$ <?php echo e(number_format($entradaEsperadaEdicao, 2, ',', '.')); ?></div>
                                ...
                                <div class="bg-white rounded-xl p-4 border border-blue-100">
                                    ...
                                    <div class="text-lg font-bold text-slate-900">R$ <?php echo e(number_format($entradaCaixaEdicao, 2, ',', '.')); ?></div>
                                ...
                                <div class="bg-white rounded-xl p-4 border border-blue-100">
                                    ...
                                    ?>
                                    <div class="text-lg font-bold <?php echo e($diferenca >= 0 ? 'text-green-600' : 'text-red-600'); ?>">
                                        <?php echo e($diferenca >= 0 ? '+' : ''); ?>R$ <?php echo e(number_format($diferenca, 2, ',', '.')); ?>

                                    </div>
                                    <div class="text-xs text-slate-500 mt-1">
                                        <?php echo e($diferenca >= 0 ? 'Acima do esperado' : 'Abaixo do esperado'); ?>
...
<?php /**PATH /var/www/pagby/resources/views/livewire/proprietario/ajuste-balanco-diario.blade.php ENDPATH**/ ?>