    ...
    <div class="flex-1 flex flex-col items-center justify-center text-center px-4 py-10">
        <div class="max-w-2xl mx-auto">
                    ...
                    <div class="space-y-4">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="font-bold text-purple-600 capitalize">
                                <?php echo e(session('plan') ?? $plan ?? 'Premium'); ?>
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <span class="font-semibold text-gray-800">
                                <?php echo e(session('tenant_name') ?? 'Novo Cliente'); ?>
                    ...
                    <div class="space-y-4">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="font-mono text-sm text-gray-800 bg-gray-100 px-2 py-1 rounded">
                                <?php echo e(session('payment_id') ?? $payment_id ?? 'SIM_' . time()); ?>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                ...
                <a href="<?php echo e(route('tenant.home')); ?>" 
...
<?php endif; ?><?php /**PATH /var/www/pagby/resources/views/pagby-subscription/success-renew.blade.php ENDPATH**/ ?>