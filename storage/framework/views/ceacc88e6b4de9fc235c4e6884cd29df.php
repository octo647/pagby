<div class="space-y-6">
    ...
    <!--[if BLOCK]><![endif]--><?php if($produtosMaisVendidos->isEmpty()): ?>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $produtosMaisVendidos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $produto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($produto->observacoes): ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($produto->quantidade_atual <= $produto->quantidade_minima): ?>
...
<?php /**PATH /home/helder/projetos/pagby/resources/views/livewire/proprietario/fidelidade/produtos.blade.php ENDPATH**/ ?>