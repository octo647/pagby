...
<?php endif; ?>
        ...
        <div class="flex items-center justify-between mt-4">
            <label for="remember_me" class="inline-flex items-center">
                ...
                <span class="ms-2 text-sm text-gray-600"><?php echo e(__('Lembre-se de mim')); ?></span>
            </label>
            <?php if(tenant()): ?>
                <?php
                ...
                ?>
                <a class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 ml-4" href="<?php echo e($isSubdomain ? '/forgot-password' : '/' . tenant()->id . '/forgot-password'); ?>">
                    <?php echo e(__('Esqueceu sua senha?')); ?>

                </a>
            <?php else: ?>
                <a class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 ml-4" href="<?php echo e(route('password.request')); ?>">
                    <?php echo e(__('Esqueceu sua senha?')); ?>
        ...
        <div class="mt-4 flex justify-between items-center">
            ...
            <a href="/register" class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                <?php echo e(__('Não tem uma conta? Registre-se')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['class' => 'w-full py-2 px-4 text-base font-semibold rounded-lg']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-full py-2 px-4 text-base font-semibold rounded-lg']); ?>
               <span class="block w-full text-center "> <?php echo e(__('Entrar')); ?></span>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    ...
    <div class="social-login mt-8">
        ...
        <a href="<?php echo e(config('app.central_url', 'https://pagby.com.br') . '/auth/google?tenant=' . tenant()->id); ?>"
...
<?php endif; ?>
<?php /**PATH /home/helder/projetos/pagby/resources/views/auth/login.blade.php ENDPATH**/ ?>