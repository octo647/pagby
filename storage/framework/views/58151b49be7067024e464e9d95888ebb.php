...
<?php $component->withAttributes([]); ?>
    <main class="flex-1 flex flex-col items-center justify-center text-center bg-gray-900 px-4 py-10">
        ...
        <a href="<?php echo e(route('register-tenant')); ?>" class="bg-gradient-to-r from-pink-600 to-indigo-600 text-white px-6 py-3 rounded-full text-lg font-bold shadow hover:from-pink-700 hover:to-indigo-700 transition mb-8">Quero meu negócio no PagBy</a>
        <div id="funcionalidades" class="mt-10 bg-white/10 rounded-xl p-8 shadow max-w-2xl">
            ...
            <button class="mt-4 bg-pink-600 text-white px-4 py-2 rounded-full text-sm font-bold shadow hover:bg-pink-700 transition">
                <a href="<?php echo e(route('funcionalidades')); ?>">Ver todas as funcionalidades</a>
            </button>
        </div>
        <div class="mt-4 bg-white/10 rounded-xl p-8 shadow max-w-2xl text-white/80">
            ...
            <a href="<?php echo e(route('register-tenant')); ?>" class="bg-gradient-to-r from-pink-600 to-indigo-600 text-white px-6 py-3 rounded-full text-lg font-bold shadow hover:from-pink-700 hover:to-indigo-700 transition">Criar conta gratuita</a>
...
<?php endif; ?><?php /**PATH /var/www/pagby/resources/views/home_back.blade.php ENDPATH**/ ?>