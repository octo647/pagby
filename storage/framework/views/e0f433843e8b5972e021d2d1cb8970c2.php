<div class="space-y-6">
    ...
    <div class="grid md:grid-cols-2 gap-4">
        <!-- WhatsApp -->
        <a 
            href="https://api.whatsapp.com/send?text=<?php echo e($whatsappText); ?>"
            target="_blank"
        ...
        <!-- Facebook -->
        <a 
            href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(urlencode($bookingUrl)); ?>&quote=<?php echo e($facebookText); ?>"
            target="_blank"
        ...
        <!-- Twitter/X -->
        <a 
            href="https://twitter.com/intent/tweet?text=<?php echo e($twitterText); ?>"
            target="_blank"
...
<script>
    ...
    function copyInstagramText() {
        const text = decodeURIComponent('<?php echo e($instagramText); ?>');
        navigator.clipboard.writeText(text).then(() => {
            alert('✓ Texto copiado! Cole no Instagram e adicione o link: <?php echo e($bookingUrl); ?>');
        });
    }
</script>
<?php /**PATH /var/www/pagby/resources/views/livewire/create-post.blade.php ENDPATH**/ ?>