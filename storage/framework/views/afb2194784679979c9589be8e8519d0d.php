<div class="p-6 space-y-6">
    ...
    <div class="mt-6">
        <!--[if BLOCK]><![endif]--><?php if($abaSelecionada === 'visao-geral'): ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($modalVinculo): ?>
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['serviceId'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div>
                                ...
                                <select wire:model="estoqueId" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $produtos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['estoqueId'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <div>
                                    ...
                                    <input type="number" wire:model="percentualDesconto" min="0" max="100" step="0.01" 
                                           class="w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['percentualDesconto'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs"><?php echo e($message); ?></span> <?php unset($message);
...
<?php /**PATH /home/helder/projetos/pagby/resources/views/livewire/proprietario/dashboard-fidelidade.blade.php ENDPATH**/ ?>