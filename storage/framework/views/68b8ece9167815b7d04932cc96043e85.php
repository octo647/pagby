                ...
                <div class="bg-blue-50 rounded-xl shadow-lg border border-blue-100 p-6 flex flex-col gap-2 hover:scale-[1.02] transition-transform">
                    ...
                    <div class="flex flex-col gap-1">
                        <div class="flex justify-between text-sm">
                            ...
                            <span class="font-semibold text-blue-900"><?php echo e($pagamentos['tempo_total'] ?? 0); ?></span>
                        </div>
                        <div class="flex justify-between text-sm">
                            <span class="text-gray-600">% do tempo:</span>
                            <span class="font-semibold text-blue-900"><?php echo e(number_format($pagamentos['percentual_tempo'] ?? 0, 2, ',', '.')); ?>%</span>
                        </div>
                        <div class="flex justify-between text-sm">
                            <span class="text-gray-600">Valor a receber:</span>
                            <span class="font-semibold text-green-700">R$ <?php echo e(number_format($pagamentos['valor'] ?? 0, 2, ',', '.')); ?></span>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH /var/www/pagby/resources/views/livewire/funcionario/controle-pagamento-planos.blade.php ENDPATH**/ ?>