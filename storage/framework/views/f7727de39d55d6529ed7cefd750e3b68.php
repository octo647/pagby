...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title><?php echo e(config('app.name', 'Pagby')); ?></title>
    ...
    <div class="min-h-screen" style="display:flex; flex-direction:column;">
            ...
            <!-- conteúdo do header igual -->
             <div class="container mx-auto flex items-center justify-between px-4">
                    <div class="flex items-center gap-2">     
                        <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo Pagby" class="h-8 w-auto">          
                    </div>
                    ...
                    <div class="flex items-center gap-4">
                        <a href="<?php echo e(route('register-tenant')); ?>" class="bg-white text-pink-700 px-4 py-2 rounded-full text-sm font-bold shadow hover:bg-pink-100 transition">Registrar</a>
                    </div>
                </div>
        </header>
        ...
        <footer class="w-full bg-gradient-to-r from-indigo-900 via-purple-900 to-pink-700 text-center text-white text-sm py-4">
            <!-- conteúdo do footer igual -->
             &copy; <?php echo e(date('Y')); ?> <span class="font-bold">PagBy</span> . Todos os direitos reservados. <span class="ml-2">PagBy.tech</span>
            </footer>
        
    </div>
</body>
</html><?php /**PATH /var/www/pagby/resources/views/components/pagby-layoutbackup.blade.php ENDPATH**/ ?>