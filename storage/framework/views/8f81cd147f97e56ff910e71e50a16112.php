<div class="min-h-screen bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8 sm:pb-12">
        <div class="bg-white shadow-xl rounded-2xl overflow-hidden">
            <!--[if BLOCK]><![endif]--><?php if($historico->isEmpty()): ?>
                ...
                <div class="hidden md:block overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $historico; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agendamento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-gray-50 transition-colors duration-200">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <div class="text-xs text-gray-500">
                                            <?php echo e(\Carbon\Carbon::parse($agendamento->appointment_date)->locale('pt_BR')->isoFormat('dddd')); ?>

                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-900 font-medium"><?php echo e($agendamento->services); ?></div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-10 w-10">
                                                <div class="h-10 w-10 rounded-full bg-gradient-to-r from-blue-400 to-purple-500 flex items-center justify-center text-white font-semibold">
                                                    <?php echo e(substr($agendamento->employee->name, 0, 2)); ?>

                                                </div>
                                            </div>
                                            <div class="ml-4">
                                                <div class="text-sm font-medium text-gray-900"><?php echo e($agendamento->employee->name); ?></div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <!--[if BLOCK]><![endif]--><?php if($agendamento->avaliacao): ?>
                                            <div class="space-y-2">
                                                
                                                <div class="flex items-center space-x-1">
                                                    <!--[if BLOCK]><![endif]--><?php for($i = 1; $i <= 5; $i++): ?>
                                                        <!--[if BLOCK]><![endif]--><?php if($i <= $agendamento->avaliacao->avaliacao): ?>
                                                    ...
                                                    <span class="text-sm text-gray-500 ml-2"><?php echo e($agendamento->avaliacao->avaliacao); ?>/5</span>
                                                </div>
                                                
                                                <!--[if BLOCK]><![endif]--><?php if($agendamento->avaliacao->comentario): ?>
                                                    <p class="text-sm text-gray-700 mt-1"><?php echo e($agendamento->avaliacao->comentario); ?></p>
                                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                                
                                                <button wire:click="editarAvaliacao(<?php echo e($agendamento->id); ?>)" 
                                        ...
                                        <?php else: ?>
                                            <button wire:click="avaliar(<?php echo e($agendamento->id); ?>)" 
                        ...
                        <div class="bg-white border border-gray-200 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow duration-200">
                            ...
                            <div class="flex items-center justify-between mb-4">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <h3 class="font-medium text-gray-900 text-sm"><?php echo e($agendamento->employee->name); ?></h3>
                            ...
                            <div class="mb-4">
                                <div class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                    ...
                                    <?php echo e($agendamento->services); ?>
                            ...
                            <div class="pt-3 border-t border-gray-100">
                                <!--[if BLOCK]><![endif]--><?php if($agendamento->avaliacao): ?>
                                    <div class="space-y-3">
                                        ...
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center space-x-1">
                                                <!--[if BLOCK]><![endif]--><?php for($i = 1; $i <= 5; $i++): ?>
                                                    ...
                                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                                <?php endfor; ?><!--[if ENDBLOCK]><![endif]-->
                                                <span class="text-xs text-gray-500 ml-2"><?php echo e($agendamento->avaliacao->avaliacao); ?>/5</span>
                                            </div>
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($agendamento->avaliacao->comentario): ?>
                                            <p class="text-sm text-gray-700 bg-gray-50 p-3 rounded-lg"><?php echo e($agendamento->avaliacao->comentario); ?></p>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    </div>
                                <?php else: ?>
                    ...
                    <form wire:submit.prevent="updateAvaliacao" class="space-y-6">        
                        ...
                        <div>
                            ...
                            <div class="flex items-center justify-center space-x-1 py-4 bg-gray-50 rounded-xl">
                                <!--[if BLOCK]><![endif]--><?php for($i = 1; $i <= 5; $i++): ?>
                                    <button type="button" 
                                            wire:click="$set('avaliacao', <?php echo e($i); ?>)" 
                                            class="focus:outline-none transform hover:scale-110 transition-all duration-200">
                                        <svg class="w-10 h-10 <?php echo e($avaliacao >= $i ? 'text-yellow-400' : 'text-gray-300'); ?> hover:text-yellow-300" 
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($avaliacao > 0): ?>
                                <p class="text-center text-sm text-gray-600 mt-2"><?php echo e($avaliacao); ?> de 5 estrelas</p>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        </div>
...
<?php /**PATH /home/helder/projetos/pagby/resources/views/livewire/cliente/historico.blade.php ENDPATH**/ ?>