<div>
    ...
    <?php if(session()->has('mensagem')): ?>
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4">
            <div class="bg-green-50 border border-green-200 rounded-xl p-4 flex items-center space-x-3">
                ...
                <p class="text-green-800 font-medium"><?php echo e(session('mensagem')); ?></p>
            </div>
        </div>
    <?php endif; ?>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-100">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-slate-900"><?php echo e($estoque->total()); ?></p>
                        <p class="text-sm text-slate-500 mt-1">
                            <?php
                                $valorTotal = $estoque->sum('valor_total');
                            ?>
                            Valor: R$ <?php echo e(number_format($valorTotal, 2, ',', '.')); ?>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-100">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        ?>
                        <p class="text-3xl font-bold text-orange-600"><?php echo e($estoqueBaixo); ?></p>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-100">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        ?>
                        <p class="text-3xl font-bold text-red-600"><?php echo e($vencidos); ?></p>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-100">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        ?>
                        <p class="text-3xl font-bold text-yellow-600"><?php echo e($venceEmBreve); ?></p>
                ...
                <div>
                    ...
                    <select wire:model.live="branch_id" class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors">
                        ...
                        <?php $__currentLoopData = $filiais; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($filial->id); ?>"><?php echo e($filial->branch_name); ?></option>
    ...
    <div class="hidden lg:block bg-white rounded-2xl shadow-lg overflow-hidden border border-slate-100 max-w-full">
            ...
            <div class="overflow-x-auto w-full">
                <table class="min-w-full w-full divide-y divide-slate-200">
                    ...
                    <tbody class="bg-white divide-y divide-slate-200">
                        <?php $__empty_1 = true; $__currentLoopData = $estoque; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr wire:key="desktop-<?php echo e($item->id); ?>" class="hover:bg-slate-50 transition-colors duration-200
                                <?php if($item->isEstoqueBaixo()): ?> bg-orange-50 border-l-4 border-l-orange-400 
                                <?php elseif($item->isVencido()): ?> bg-red-50 border-l-4 border-l-red-500 
                                <?php elseif($item->venceEmBreve()): ?> bg-yellow-50 border-l-4 border-l-yellow-400 
                                <?php else: ?> hover:bg-slate-50 <?php endif; ?>">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-start space-x-3">
                                        ...
                                        <div>
                                            <div class="font-semibold text-slate-900"><?php echo e($item->produto_nome); ?></div>
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-sm font-medium text-slate-900"><?php echo e($item->branch->branch_name); ?></span>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 text-center">
                                    <div class="inline-flex flex-col items-center">
                                        <span class="text-lg font-bold <?php if($item->isEstoqueBaixo()): ?> text-orange-600 <?php else: ?> text-slate-900 <?php endif; ?>">
                                            <?php echo e($item->quantidade_atual); ?>

                                        </span>
                                        <span class="text-xs text-slate-500">mín: <?php echo e($item->quantidade_minima); ?></span>
                                        ...
                                        <div class="w-16 bg-slate-200 rounded-full h-1.5 mt-1">
                                            <div class="h-1.5 rounded-full <?php if($item->isEstoqueBaixo()): ?> bg-orange-500 <?php elseif($percentualEstoque > 70): ?> bg-green-500 <?php else: ?> bg-yellow-500 <?php endif; ?>" 
                                                 style="width: <?php echo e($percentualEstoque); ?>%"></div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <!-- Percentual Comissão -->
                                <td class="px-6 py-4 text-center">
                                    <?php if($item->percentual_produtos && $item->percentual_produtos > 0): ?>
                                        <div class="inline-flex items-center px-3 py-1 rounded-full bg-emerald-100 text-emerald-800">
                                            ...
                                            <span class="text-sm font-semibold"><?php echo e(number_format($item->percentual_produtos, 2, ',', '.')); ?>%</span>
                                        </div>
                                    <?php else: ?>
                                ...
                                <!-- Validade -->
                                <td class="px-6 py-4 text-center">
                                    <?php if($item->data_validade): ?>
                                        <div class="flex flex-col items-center">
                                            <span class="text-sm font-medium <?php if($item->isVencido()): ?> text-red-600 <?php elseif($item->venceEmBreve()): ?> text-yellow-600 <?php else: ?> text-slate-900 <?php endif; ?>">
                                                <?php echo e($item->data_validade->format('d/m/Y')); ?>

                                            </span>
                                            <?php if($item->isVencido()): ?>
                                                <span class="text-xs text-red-500 mt-1">Vencido</span>
                                            <?php elseif($item->venceEmBreve()): ?>
                                                <span class="text-xs text-yellow-600 mt-1">
                                                    <?php echo e($item->data_validade->diffInDays(now())); ?> dias
                                                </span>
                                            <?php endif; ?>
                                        </div>
                                    <?php else: ?>
                                ...
                                <td class="px-6 py-4 text-center">
                                    ...
                                    <?php elseif($item->isEstoqueBaixo()): ?>
                                ...
                                <td class="px-6 py-4 text-center">
                                    <div class="flex justify-center items-center space-x-2">
                                        <button wire:click="editarEstoque(<?php echo e($item->id); ?>)" 
                                        ...
                                        <button wire:click="excluir(<?php echo e($item->id); ?>)" 
        ...
        <div class="lg:hidden space-y-4">
            <?php $__empty_1 = true; $__currentLoopData = $estoque; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div wire:key="mobile-<?php echo e($item->id); ?>" class="bg-white rounded-2xl shadow-lg border border-slate-100 overflow-hidden transition-all duration-300 hover:shadow-xl
                    <?php if($item->isEstoqueBaixo()): ?> border-l-4 border-l-orange-400 
                    <?php elseif($item->isVencido()): ?> border-l-4 border-l-red-500 
                    <?php elseif($item->venceEmBreve()): ?> border-l-4 border-l-yellow-400 
                    <?php else: ?> border-l-4 border-l-green-500 
                    <?php endif; ?>">
                        ...
                        <div class="flex items-start justify-between">
                            <div class="flex-1 flex items-start space-x-3">
                                ...
                                <div class="flex-1 min-w-0">
                                    <h3 class="font-bold text-slate-900 text-lg leading-tight"><?php echo e($item->produto_nome); ?></h3>
                                    <?php if($item->fornecedor): ?>
                                    ...
                                    <p class="text-xs text-slate-500 mt-1 flex items-center">
                                        ...
                                        <?php echo e($item->branch->branch_name); ?>
                    ...
                    <div class="p-5">
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-5">
                            ...
                            <div class="bg-slate-50 rounded-xl p-4">
                                ...
                                <div class="flex items-baseline space-x-2">
                                    <span class="text-2xl font-bold <?php if($item->isEstoqueBaixo()): ?> text-orange-600 <?php else: ?> text-slate-900 <?php endif; ?>">
                                        <?php echo e($item->quantidade_atual); ?>

                                    </span>
                                    <span class="text-sm text-slate-500">/ <?php echo e($item->quantidade_minima); ?> mín</span>
                                </div>
                                ...
                                <div class="mt-2">
                                    <div class="w-full bg-slate-200 rounded-full h-2">
                                        <div class="h-2 rounded-full <?php if($item->isEstoqueBaixo()): ?> bg-orange-500 <?php elseif($percentualEstoque > 70): ?> bg-green-500 <?php else: ?> bg-yellow-500 <?php endif; ?> transition-all duration-300" 
                                             style="width: <?php echo e($percentualEstoque); ?>%"></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-indigo-50 rounded-xl p-4">
                                ...
                                <div class="text-sm font-medium text-slate-900">
                                    <?php echo e($item->categoria ?: 'Sem categoria'); ?>
                        ...
                        <div class="bg-purple-50 rounded-xl p-4 mb-5">
                            ...
                            <div class="text-lg font-bold text-purple-600">
                                <?php echo e(number_format($item->percentual_produtos, 2, ',', '.')); ?>%
                            </div>
                        ...
                        <?php if($item->data_validade): ?>
                            <div class="bg-yellow-50 rounded-xl p-4 mb-5">
                                ...
                                <div class="flex items-center justify-between">
                                    <span class="text-sm font-bold <?php if($item->isVencido()): ?> text-red-600 <?php elseif($item->venceEmBreve()): ?> text-yellow-600 <?php else: ?> text-slate-900 <?php endif; ?>">
                                        <?php echo e($item->data_validade->format('d/m/Y')); ?>

                                    </span>
                                    <?php if($item->venceEmBreve() && !$item->isVencido()): ?>
                                        <span class="text-xs text-yellow-600 font-medium">
                                            <?php echo e($item->data_validade->diffInDays(now())); ?> dias restantes
                                        </span>
                                    <?php endif; ?>
                                </div>
                            </div>
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-white">
                                <?php echo e($editando ? 'Editar Produto' : 'Adicionar Novo Produto'); ?>

                            </h3>
                            <p class="text-indigo-100 text-sm">
                                <?php echo e($editando ? 'Atualize as informações do produto' : 'Preencha os dados para cadastrar um novo produto'); ?>
                        ...
                        <div class="bg-emerald-50 rounded-2xl p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <?php $__errorArgs = ['quantidade_atual'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> 
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="number" wire:model="quantidade_minima" min="0" placeholder="0"
                                           class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors">
                                    <?php $__errorArgs = ['quantidade_minima'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> 
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <?php $__errorArgs = ['percentual_produtos'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> 
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="flex justify-end space-x-4 pt-6 border-t border-slate-200">
                            ...
                            <button type="submit" 
                                ...
                                <?php echo e($editando ? 'Atualizar Produto' : 'Salvar Produto'); ?>
    ...
    <?php endif; ?>
</div><?php /**PATH /var/www/pagby/resources/views/livewire/proprietario/gerenciar-estoque.blade.php ENDPATH**/ ?>