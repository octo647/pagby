<div class="min-h-screen bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        ...
        ?>
        <?php if(count($agendamentosFiltrados)>0): ?>
            
            <div class="space-y-6">

                <?php $__currentLoopData = $agendamentosFiltrados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$schedule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="text-right">
                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium
                                        ...
                                        <?php if($schedule['status'] === 'Confirmado'): ?> ✅
                        ...
                        <div class="p-6">
                            ...
                            ?>
                            <?php if($comandas && count($comandas) > 0): ?>
                            ...
                            <?php if($schedule['status'] !== 'Cancelado'): ?>
                                ...
                                <div class="px-6 py-4 bg-gray-50 border-t border-gray-100">
                                    <div class="flex justify-end">
                                        ...
                                        <?php if($hoje && $diffMinutos < 0): ?>
                                            <?php if($diffMinutos < -120): ?>
                                                <div class="text-left w-full text-sm text-gray-700 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                                                    ...
                                                    <?php if(!empty($schedule['professional_phone'])): ?>
...
<?php /**PATH /var/www/pagby/resources/views/livewire/cliente/appointments.blade.php ENDPATH**/ ?>