    ...
    <div class="max-w-4xl mx-auto text-center">
        <div class="bg-red-100 border border-red-400 text-red-700 px-6 py-8 rounded-lg mb-8">
            ...
            <?php if($tenant->isTrialExpired()): ?>
                <p class="text-lg mb-4">
                    Seu período de teste de 30 dias expirou em <strong><?php echo e($tenant->trial_ends_at->format('d/m/Y H:i')); ?></strong>.
                </p>
                <p class="mb-6">
                    Para continuar usando nossa plataforma, ative sua assinatura abaixo.
                </p>
            <?php elseif($tenant->isSubscriptionExpired()): ?>
                <p class="text-lg mb-4">
                    Sua assinatura expirou em <strong><?php echo e($tenant->subscription_ends_at->format('d/m/Y H:i')); ?></strong>.
                </p>
                <p class="mb-6">
        ...
        <div class="fade-in mt-16 max-w-3xl w-full mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-xl p-8 mb-8">
                <form id="form-plano" class="grid grid-cols-1 md:grid-cols-2 gap-8 items-end" method="POST" action="<?php echo e(route('tenant.renew')); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="mt-8 text-center">
                        <div id="avisoFuncionarios" class="hidden text-red-600 text-lg font-semibold mb-4">
                            Para mais de 7 funcionários, consulte valores pelo WhatsApp <a href="https://wa.me/<?php echo e(config('pagby.whatsapp_number')); ?>" class="underline text-green-700" target="_blank"><?php echo e(config('pagby.whatsapp_display')); ?></a>.
                        </div>
...
<?php /**PATH /var/www/pagby/resources/views/tenant/subscription/blocked.blade.php ENDPATH**/ ?>