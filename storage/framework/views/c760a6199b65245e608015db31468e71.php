                    ...
                    <div class="bg-gradient-to-r from-blue-500 to-cyan-600 rounded-lg shadow-sm p-6 text-white">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-bold"><?php echo e(number_format($totalAgendamentos)); ?></p>
                            </div>
                    ...
                    <div class="bg-gradient-to-r from-red-500 to-pink-600 rounded-lg shadow-sm p-6 text-white">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-xl font-bold"><?php echo e(str_pad($horarioPico->hora ?? 0, 2, '0', STR_PAD_LEFT)); ?>:00</p>
                                <p class="text-red-100 text-xs"><?php echo e($horarioPico->total ?? 0); ?> agendamentos</p>
                            </div>
                    ...
                    <div class="bg-gradient-to-r from-green-500 to-emerald-600 rounded-lg shadow-sm p-6 text-white">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-xl font-bold"><?php echo e(str_pad($horarioMenor->hora ?? 0, 2, '0', STR_PAD_LEFT)); ?>:00</p>
                                <p class="text-green-100 text-xs"><?php echo e($horarioMenor->total ?? 0); ?> agendamentos</p>
                            </div>
                    ...
                    <div class="bg-gradient-to-r from-purple-500 to-indigo-600 rounded-lg shadow-sm p-6 text-white">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-bold"><?php echo e(number_format($mediaHorarios, 1)); ?></p>
                    ...
                    <div class="p-6">
                        <?php if(count($horarios) > 0): ?>
                            <div class="space-y-3 max-h-96 overflow-y-auto">
                                <?php $__currentLoopData = collect($horarios)->sortByDesc('total'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $horario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                <div class="flex items-center justify-between p-3 bg-gradient-to-r from-gray-50 to-white rounded-lg border border-gray-200 hover:shadow-md transition-all">
                                    <div class="flex items-center space-x-3">
                                        <div class="flex-shrink-0">
                                            <div class="w-10 h-10 rounded-lg flex items-center justify-center
                                                       <?php echo e($isHighPeak ? 'bg-red-100 text-red-700' : 'bg-blue-100 text-blue-700'); ?>">
                                        ...
                                        <div>
                                            <p class="text-sm font-bold text-gray-900"><?php echo e($horaFormatada); ?></p>
                                            <div class="flex items-center space-x-2">
                                                <p class="text-xs text-gray-500"><?php echo e(number_format($percentual, 1)); ?>% do total</p>
                                                <?php if($isHighPeak): ?>
                                    ...
                                    <div class="text-right">
                                        <p class="text-lg font-bold text-gray-900"><?php echo e($horario->total); ?></p>
                                        <div class="w-16 bg-gray-200 rounded-full h-1.5 mt-1">
                                            <div class="bg-gradient-to-r <?php echo e($isHighPeak ? 'from-red-400 to-red-600' : 'from-blue-400 to-blue-600'); ?> h-1.5 rounded-full" 
                                                 style="width: <?php echo e(min($percentual, 100)); ?>%"></div>
                                        </div>
                                    </div>
                                </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        const dados = <?php echo json_encode([
            'horasLabels' => $horasLabels, 'horasValores' => $horasValores
        ], 512) ?>;
...
<?php /**PATH /var/www/pagby/resources/views/livewire/horarios-pico.blade.php ENDPATH**/ ?>