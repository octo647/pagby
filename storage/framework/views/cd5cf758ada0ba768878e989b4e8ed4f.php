    ...
    <?php if(session()->has('message') || session()->has('warning')): ?>
        <div class="mb-6">
            <div class="flex items-center p-4 text-sm text-green-800 rounded-lg bg-green-50 border border-green-200" role="alert">
                ...
                <div>
                    <span class="font-medium"><?php echo e(session('message') ?? session('warning')); ?></span>
                </div>
            </div>
        </div>
    <?php endif; ?>
...
<div x-data="{ 
    ...
    syncDescontos() {
        ...
        window.Livewire.find('<?php echo e($_instance->getId()); ?>').call('sincronizarDescontos');
    }
}" 
...
class="min-h-screen bg-gray-50">
    ...
    <div class="container mx-auto px-4 pb-8">
        ...
        <?php if(request('cancel') && request('message')): ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
                <?php $__currentLoopData = $planos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plano): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow duration-300
                        <?php if(auth()->user()->hasRole('Cliente') && auth()->user()->currentSubscription() && auth()->user()->currentSubscription()->plan_id == $plano['id']): ?> ring-2 ring-blue-500 <?php endif; ?>">
                        
                        
                        <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4 text-white">
                            <div class="flex justify-between items-start">
                                <div>
                                    <h3 class="text-xl font-bold"><?php echo e($plano['name']); ?></h3>
                                    <?php if(auth()->user()->hasRole('Cliente') && auth()->user()->currentSubscription() && auth()->user()->currentSubscription()->plan_id == $plano['id']): ?>
                                ...
                                <div class="text-right">
                                    <div class="text-3xl font-bold">R$ <?php echo e(number_format($plano['price'], 0, ',', '.')); ?></div>
                                    <div class="text-blue-100 text-sm">por <?php echo e($plano['duration'] ?? 30); ?> dias</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <ul class="space-y-2">
                                    <?php $__currentLoopData = $plano['services']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php if(count($plano['additional_services_with_discounts'] ?? []) > 0): ?>
                            <div>
                                <h4 class="font-semibold text-gray-900 mb-3 flex items-center">
                                ...
                                <ul class="space-y-2">
                                    <?php $__currentLoopData = $plano['additional_services_with_discounts']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $additionalService): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="flex items-center justify-between text-sm">
                                            <div class="flex items-center text-gray-700">
                                                <div class="w-1.5 h-1.5 bg-blue-500 rounded-full mr-3"></div>
                                                <?php echo e($additionalService['name']); ?>

                                            </div>
                                            <?php if($additionalService['discount'] > 0): ?>
                                                <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                                    <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"></path>
                                                    </svg>
                                                    <?php echo e($additionalService['discount']); ?>% OFF
                                                </span>
                                            <?php endif; ?>
                                        </li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div>
                                ...
                                <div class="space-y-2">
                                    <?php $__currentLoopData = $plano['features']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex justify-between items-center text-sm">
                                            <span class="text-gray-700"><?php echo e($key); ?></span>
                                            <span class="font-medium text-purple-600"><?php echo e($feature); ?></span>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            </div>
                        ...
                        <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                            <?php if(auth()->user()->hasRole('Cliente')): ?>
                                <?php if(auth()->user()->currentSubscription() && auth()->user()->currentSubscription()->plan_id == $plano['id']): ?>
                                    <div class="space-y-3">
                                        <p class="text-sm text-blue-600 font-medium text-center">✓ Você está assinando este plano</p>
                                        <?php if($this->assinaturaAtiva): ?>
                                        <form method="POST" action="<?php echo e(route('tenant-assinatura.cancelar')); ?>" onsubmit="return confirm('Tem certeza que deseja cancelar a assinatura?');">
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name="payment_id" value="<?php echo e($this->assinaturaAtiva->id); ?>">
                                ...
                                <?php elseif(!auth()->user()->currentSubscription()): ?>
                                    <div class="space-y-3">
                                        <p class="text-xs text-gray-500 text-center">Você não possui um plano ativo</p>
                                        <button wire:click="assinarPlano('<?php echo e($plano['id']); ?>')" 
            ...
            <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4 text-white">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-blue-100 text-sm"><?php echo e($nomePlano); ?></p>
                    </div>
                ...
                <form wire:submit.prevent="updatePlan" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="border border-gray-300 rounded-md p-3 bg-gray-50 min-h-[60px] flex items-center justify-between">
                            <div class="flex-1">
                                <?php if(count($servicosIncluidos)): ?>
                                    <div class="text-sm text-gray-700">
                                        <?php echo e(collect($todosServicos)->whereIn('id', $servicosIncluidos)->pluck('service')->join(', ')); ?>
                    ...
                    <div>
                        ...
                        <div class="border border-gray-300 rounded-md p-3 bg-gray-50 min-h-[60px] flex items-center justify-between">
                            <div class="flex-1">
                                <?php if(count($servicosAdicionais)): ?>
                                    <div class="text-sm text-gray-700">
                                        <?php echo e(collect($todosServicos)->whereIn('id', $servicosAdicionais)->pluck('service')->join(', ')); ?>
                        ...
                        <?php if(count($servicosAdicionais)): ?>
                            <div class="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-md">
                                ...
                                <div class="space-y-3">
                                    <?php $__currentLoopData = collect($todosServicos)->whereIn('id', $servicosAdicionais); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $servico): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex items-center justify-between p-2 bg-white rounded border">
                                            <span class="text-sm font-medium text-gray-700"><?php echo e($servico->service); ?></span>
                                            <div class="flex items-center space-x-2">
                                                <input type="number" 
                                                       wire:model="servicosAdicionaisDescontos.<?php echo e($servico->id); ?>"
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-4 gap-2">
                            <?php $__currentLoopData = ['segunda','terca','quarta','quinta','sexta','sabado','domingo']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label class="flex items-center p-2 border border-gray-200 rounded-md hover:bg-gray-50 cursor-pointer">
                                    <input type="checkbox" wire:model="allowedDays" value="<?php echo e($dia); ?>" class="mr-2 rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                    <span class="text-sm"><?php echo e(ucfirst($dia)); ?></span>
                                </label>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="space-y-3">
                            <?php if(is_array($planoSelecionado->features) && count($planoSelecionado->features)): ?>
                                <?php $__currentLoopData = $features_keys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center space-x-2 p-3 bg-gray-50 rounded-md border">
                                        <input type="text" 
                                               wire:model="features_keys.<?php echo e($index); ?>" 
                                        ...
                                        <input type="text" 
                                               wire:model="features_values.<?php echo e($index); ?>" 
                                               class="flex-1 border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500" 
                                               placeholder="Valor">
        ...
        <div class="bg-white rounded-lg shadow-xl w-full max-w-lg mx-4">
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 gap-2 max-h-80 overflow-y-auto">
                    <?php $__currentLoopData = $todosServicos->whereNotIn('id', $servicosAdicionais); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $servico): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div x-show="openServicosAdicionais" x-cloak class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
        <div class="bg-white rounded-lg shadow-xl w-full max-w-lg mx-4">
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 gap-2 max-h-80 overflow-y-auto">
                    <?php $__currentLoopData = $todosServicos->whereNotIn('id', $servicosIncluidos); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $servico): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label class="flex items-center p-3 border border-gray-200 rounded-md hover:bg-gray-50 cursor-pointer transition-colors">
                            <input type="checkbox" 
                ...
                <div class="mb-4">
                            ...
                            <div class="space-y-3">
                                <?php $__currentLoopData = collect($todosServicos)->whereIn('id', $servicosAdicionais); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $servico): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center justify-between p-2 bg-white rounded border">
                                        ...
                                        <div class="flex items-center space-x-2">
                                            <input type="number" 
                                                   wire:model.blur="servicosAdicionaisDescontos.<?php echo e($servico->id); ?>"
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-4 gap-2">
                            <?php $__currentLoopData = ['segunda','terca','quarta','quinta','sexta','sabado','domingo']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label class="flex items-center p-2 border border-gray-200 rounded-md hover:bg-gray-50 cursor-pointer">
                                    <input type="checkbox" wire:model="allowedDays" value="<?php echo e($dia); ?>" class="mr-2 rounded border-gray-300 text-green-600 focus:ring-green-500">
                                    <span class="text-sm"><?php echo e(ucfirst($dia)); ?></span>
                                </label>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
    ...
    <div x-show="openServicosNovoPlano" x-cloak class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
        <div class="bg-white rounded-lg shadow-xl w-full max-w-lg mx-4">
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 gap-2 max-h-80 overflow-y-auto">
                    <?php $__currentLoopData = $todosServicos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $servico): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label class="flex items-center p-3 border border-gray-200 rounded-md hover:bg-gray-50 cursor-pointer transition-colors">
                            <input type="checkbox" 
                                   wire:model.live="servicosIncluidos" 
                                   value="<?php echo e($servico->id); ?>" 
                ...
                <div class="p-6">
                    <div class="mb-6">
                        <div class="flex items-start p-4 bg-purple-50 border border-purple-200 rounded-lg">
                            ...
                            <div>
                                <p class="text-gray-900 font-medium mb-1">CNPJ obrigatório para criar planos</p>
                                <p class="text-gray-700 text-sm">
                                    Para criar planos de assinatura e receber pagamentos dos seus clientes, é necessário informar o CNPJ do seu estabelecimento. Isso permite que você receba os pagamentos como pessoa jurídica.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">
                                CNPJ do Estabelecimento <span class="text-red-500">*</span>
                            </label>
...
<?php /**PATH /var/www/pagby/resources/views/livewire/planos-de-assinatura.blade.php ENDPATH**/ ?>