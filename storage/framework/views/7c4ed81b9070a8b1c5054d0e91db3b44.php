<div>
    <!--[if BLOCK]><![endif]--><?php if($mostrarRecompensas && count($recompensasAtivas) > 0): ?>
        <div class="mb-6 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-6 border-2 border-purple-200 shadow-lg">
            ...
            <div class="space-y-3">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $recompensasAtivas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recompensa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="flex-1">
                                ...
                                <div class="ml-8">
                                    ...
                                    <div class="flex items-center gap-4 mt-2 text-xs text-gray-500">
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($recompensa['origem']): ?>
...
<?php /**PATH /home/helder/projetos/pagby/resources/views/livewire/cliente/minhas-recompensas.blade.php ENDPATH**/ ?>