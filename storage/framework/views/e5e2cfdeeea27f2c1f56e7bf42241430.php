                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <select wire:model.live="filtro_funcionario" 
                                ...
                                <?php if($users): ?>
                                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $funcionario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="bg-white rounded-lg border border-gray-200 p-4 shadow-sm
                    ...
                    <div class="border-t pt-3 mb-3">
                        ...
                        <div class="flex justify-between items-center text-xs text-gray-500">
                            ...
                            <div>
                                <?php if($comanda->appointment_id && $comanda->appointment): ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="divide-y divide-gray-200">
                <?php $__empty_1 = true; $__currentLoopData = $salon_users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input wire:model="cliente_telefone" type="text"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                <?php $__errorArgs = ['cliente_telefone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <select wire:model="funcionario_id" wire:change="selecionarFuncionarioServico($event.target.value)" required
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                    <option value="">Selecione...</option>
                                    <?php if($funcionarios_da_filial && $funcionarios_da_filial->count() > 0): ?>
                                        <?php $__currentLoopData = $funcionarios_da_filial; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $funcionario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($funcionario->id); ?>"><?php echo e($funcionario->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php else: ?>
                                        <?php if($users): ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <select wire:model="service_id" required
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                    <option value="">Selecione...</option>
                                    <?php $__currentLoopData = $servicosDisponiveis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e(is_array($service) ? $service['id'] : $service->id); ?>">
                                            ...
                                            <?php if(isset($service['price']) || isset($service->price)): ?> - R$ <?php echo e(number_format(is_array($service) ? $service['price'] : $service->price, 2, ',', '.')); ?> <?php endif; ?>
                                            <?php if(isset($service['time']) || isset($service->time)): ?> - <?php echo e(is_array($service) ? $service['time'] : $service->time); ?> min <?php endif; ?>
                                        </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                                    ...
                                    <div x-show="showDescontos" x-transition class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input wire:model="desconto_servicos" type="number" step="0.01" min="0" max="100"
                                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                            <?php $__errorArgs = ['desconto_servicos'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div>
                                            ...
                                            <input wire:model="desconto_produtos" type="number" step="0.01" min="0" max="100"
                                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                            <?php $__errorArgs = ['desconto_produtos'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm"><?php echo e($message); ?></span> <?php unset($message);
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <select wire:model="funcionario_id" wire:change="atualizarServicosFuncionario" required
                                    ...
                                    <?php if($funcionarios_disponiveis): ?>
                                        <?php $__currentLoopData = $funcionarios_disponiveis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $funcionario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($funcionario->id); ?>"><?php echo e($funcionario->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endif; ?>
                                </select>
                            ...
                            <div class="grid grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <input wire:model="quantidade_servico" type="number" min="1" required
                                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                    <?php $__errorArgs = ['quantidade_servico'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm"><?php echo e($message); ?></span> <?php unset($message);
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <select wire:model.live="estoque_id" wire:change="atualizarPrecoProduto" required
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                    <option value="">Selecione...</option>
                                    <?php $__currentLoopData = $produtos_estoque; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input wire:model="quantidade_produto" type="number" min="1" required
                                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                    <?php $__errorArgs = ['quantidade_produto'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <?php if($mostrar_painel_detalhes && $comanda_detalhes): ?>
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
        <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-2xl mx-2 relative">
                            ...
                            <div class="mb-6 rounded-lg bg-gray-50 p-4">
                                <div class="grid grid-cols-2 gap-4 text-sm">
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            <?php if($comanda_detalhes->appointment_id && $comanda_detalhes->appointment): ?>
                                                <?php echo e($comanda_detalhes->appointment->appointment_date->format('d/m/Y')); ?> às <?php echo e(\Carbon\Carbon::createFromFormat('H:i:s', $comanda_detalhes->appointment->start_time)->format('H:i')); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-6">
                                <div class="flex items-center justify-between mb-4">
                                    <h3 class="text-lg font-medium text-gray-900">
                                        Serviços
                                        <?php if($comanda_detalhes->comandaServicos->count() > 0): ?>
                                    ...
                                    <?php if($comanda_detalhes->status === 'Aberta'): ?>
                                ...
                                <?php if($comanda_detalhes->status === 'Aberta' && $mostrandoFormServico): ?>
                                                    ...
                                                    <select wire:model.live="funcionario_servico_id" wire:change="atualizarFuncionarioServico" required
                                                        ...
                                                        <?php 
                                                            $funcionarios_painel = $funcionarios_da_filial && $funcionarios_da_filial->count() > 0 ? 
                                                                                  ...
                                                                                  ($users ?? collect());
                                                        ?>
                                                        <?php $__currentLoopData = $funcionarios_painel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($user->id); ?>"><?php echo e($user->name); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>

                                                <?php if($funcionario_servico_id): ?>
                                                <div>
                                                    <label class="block text-sm font-medium text-gray-700">Serviço *</label>
                                                    <select wire:model.live="service_id" wire:change="atualizarPrecoServico" required
                                                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm">
                                                        <option value="">Selecione...</option>
                                                        <?php $__currentLoopData = $servicosDisponiveis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branchService): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php if($comanda_detalhes->comandaServicos->count() > 0): ?>
                                    <div class="space-y-2">
                                        <?php $__currentLoopData = $comanda_detalhes->comandaServicos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $servico): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="mb-6">
                                <div class="flex items-center justify-between mb-4">
                                    <h3 class="text-lg font-medium text-gray-900">
                                        Produtos
                                        <?php if($comanda_detalhes->comandaProdutos->count() > 0): ?>
                                ...
                                <?php if($comanda_detalhes->status === 'Aberta' && $mostrandoFormProduto): ?>
                                ...
                                <?php if($comanda_detalhes->comandaProdutos->count() > 0): ?>
                                    <div class="space-y-2">
                                        <?php $__currentLoopData = $comanda_detalhes->comandaProdutos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="flex items-center justify-between bg-white border rounded-lg p-3">
                                                <div class="flex-1">
...
<?php /**PATH /var/www/pagby/resources/views/livewire/proprietario/gerenciar-comandas.blade.php ENDPATH**/ ?>