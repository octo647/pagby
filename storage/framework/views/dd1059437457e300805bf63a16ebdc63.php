                    ...
                    <div class="space-y-4">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="font-bold text-purple-600 capitalize">
                                <?php echo e($plan_name ?? session('plan') ?? $plan ?? ''); ?>
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <span class="font-semibold text-gray-800">
                                <?php echo e($tenant_name ?? session('tenant_name') ?? 'Novo Cliente'); ?>
...
<?php endif; ?><?php /**PATH /var/www/pagby/resources/views/pagby-subscription/success.blade.php ENDPATH**/ ?>