...
<body>
            ...
            <div class="col-md-8">
                <div class="card shadow">
                    ...
                    <div class="card-body text-center">
                        <div class="mb-4">
                            <h6>Quase lá! 🎉</h6>
                            <p><strong>Salão:</strong> <?php echo e($tenant_name); ?></p>
                        ...
                        <div class="mb-4" id="payment-link-section">
                            <a href="<?php echo e($payment_link); ?>" target="_blank" class="btn btn-success btn-lg">
    ...
    document.getElementById('asaas-pay-btn').addEventListener('click', function() {
        ...
        fetch('/pagby-subscription/asaas-pay/<?php echo e($payment->id); ?>', {
            method: 'POST',
            headers: {
...
</html><?php /**PATH /var/www/pagby/resources/views/pagby-subscription/wait.blade.php ENDPATH**/ ?>