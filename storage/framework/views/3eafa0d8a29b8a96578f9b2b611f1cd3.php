...
<div class="container mx-auto max-w-lg py-8">
    ...
    <form method="POST" action="<?php echo e(route('pagby-subscription.payment.process')); ?>" id="payment-form">
        <?php echo csrf_field(); ?>
        <div class="mb-4">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/pagby/resources/views/pagby-subscription/payment.blade.php ENDPATH**/ ?>