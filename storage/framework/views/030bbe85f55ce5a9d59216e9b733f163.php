                    ...
                    <tr>
                        <td style="background: linear-gradient(135deg, #ec4899 0%, #8b5cf6 100%); padding: 40px 30px; text-align: center;">
                            <h1 style="margin: 0; color: #ffffff; font-size: 28px; font-weight: bold;">
                                Bem-vindo ao <?php echo e($tenantName); ?>! 👋
                            </h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            <p style="margin: 0 0 20px 0; font-size: 16px; line-height: 1.6; color: #333333;">
                                Olá, <strong><?php echo e($user->name); ?></strong>!
                            </p>
                            ...
                            <div style="background-color: #f9fafb; border-left: 4px solid #ec4899; padding: 20px; margin: 30px 0; border-radius: 4px;">
                                ...
                                <div style="text-align: center; margin: 25px 0;">
                                    <a href="https://wa.me/<?php echo e($whatsappNumber); ?>?text=ATIVAR" 
                                ...
                                <p style="margin: 15px 0 0 0; font-size: 12px; text-align: center; color: #999999;">
                                    Nosso WhatsApp: <strong>(32) 99854-8620</strong>
                                </p>
                            </div>
                            ...
                            <p style="margin: 20px 0 0 0; font-size: 14px; line-height: 1.6; color: #666666;">
                                Atenciosamente,<br>
                                <strong>Equipe <?php echo e($tenantName); ?></strong>
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="background-color: #f9fafb; padding: 20px 30px; text-align: center; border-top: 1px solid #e5e7eb;">
                            <p style="margin: 0; font-size: 12px; color: #999999;">
                                © <?php echo e(date('Y')); ?> <?php echo e($tenantName); ?> - Powered by PagBy
                            </p>
...
<?php /**PATH /var/www/pagby/resources/views/emails/welcome-user.blade.php ENDPATH**/ ?>