<div class="min-h-screen bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        <!--[if BLOCK]><![endif]--><?php if(isset($services)): ?>
            <form wire:submit="chosen" class="space-y-8">
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                    ...
                    <div class="p-6 space-y-4">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item=>$service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
                            <label for="checkbox-<?php echo e($service['id']); ?>" 
                                ...
                                <div class="ml-4 flex-1 flex items-center justify-between">
                                    ...
                                    <div class="text-right">
                                        <div class="text-2xl font-bold text-green-600">R$ <?php echo e($service['price']); ?></div>
...
</div><?php /**PATH /home/helder/projetos/pagby/resources/views/livewire/cliente/choose-service.blade.php ENDPATH**/ ?>