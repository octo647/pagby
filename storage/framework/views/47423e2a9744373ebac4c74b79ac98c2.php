<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            <?php echo e(__('Se sua conta for apagada, todos os dados serão perdidos permanentemente. Antes de apagar sua conta, por favor faça download dos dados que você deseja manter.')); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['x-data' => '','x-on:click.prevent' => '$dispatch(\'open-modal\', \'confirm-user-deletion\')']); ?><?php echo e(__('Apagar Conta')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['name' => 'confirm-user-deletion','show' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->userDeletion->isNotEmpty()),'focusable' => true]); ?>
        <form method="post" action="<?php echo e(route('profile.destroy')); ?>" class="p-6">
            ...
            <h2 class="text-lg font-medium text-gray-900">
                <?php echo e(__('Você tem certeza que deseja apagar sua conta?')); ?>

            </h2>

            <p class="mt-1 text-sm text-gray-600">
                <?php echo e(__('Se sua conta for apagada, todos seus dados serão perdidos. Por favor, use sua password para confirmar que você deseja excluir permanentemente sua conta.')); ?>
...
<?php /**PATH /home/helder/projetos/pagby/resources/views/profile/partials/delete-user-form.blade.php ENDPATH**/ ?>