        ...
        <?php if(session()->has('message')): ?>
            <div class="bg-gradient-to-r from-green-50 to-green-100 border-l-4 border-green-500 rounded-lg p-4 mb-6">
                <div class="flex items-center">
                    ...
                    <span class="text-green-800 font-medium"><?php echo e(session('message')); ?></span>
                </div>
            </div>
        <?php endif; ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-gradient-to-r from-green-500 to-emerald-600 rounded-lg shadow-sm p-6 text-white">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-xl font-bold"><?php echo e($diaComMaisAgendamentos['dia'] ?? 'N/A'); ?></p>
                                <p class="text-green-100 text-xs"><?php echo e($diaComMaisAgendamentos['total'] ?? 0); ?> agendamentos</p>
                            </div>
                    ...
                    <div class="bg-gradient-to-r from-orange-500 to-red-600 rounded-lg shadow-sm p-6 text-white">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-xl font-bold"><?php echo e($diaComMenosAgendamentos['dia'] ?? 'N/A'); ?></p>
                                <p class="text-orange-100 text-xs"><?php echo e($diaComMenosAgendamentos['total'] ?? 0); ?> agendamentos</p>
                            </div>
                    ...
                    <div class="bg-gradient-to-r from-blue-500 to-cyan-600 rounded-lg shadow-sm p-6 text-white">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-bold"><?php echo e(number_format($mediaAgendamentos, 1)); ?></p>
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-6">
                        <?php if(count($diasPico) > 0): ?>
                            <div class="space-y-4">
                                <?php $__currentLoopData = collect($diasPico)->sortByDesc('total'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $dia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="flex items-center space-x-3">
                                        <div class="flex-shrink-0">
                                            <span class="inline-flex items-center justify-center w-8 h-8 rounded-full 
                                                       <?php echo e($index == 0 ? 'bg-yellow-100 text-yellow-800' : ($index == 1 ? 'bg-gray-100 text-gray-800' : ($index == 2 ? 'bg-orange-100 text-orange-800' : 'bg-blue-100 text-blue-800'))); ?> 
                                                       text-sm font-bold">
                                                <?php echo e($index + 1); ?>º
                                            </span>
                                        </div>
                                        <div>
                                            <p class="text-sm font-medium text-gray-900"><?php echo e($dia['dia']); ?></p>
                                            <p class="text-xs text-gray-500">
                                                <?php
                                                    $percentual = $totalAgendamentos > 0 ? ($dia['total'] / $totalAgendamentos) * 100 : 0;
                                                ?>
                                                <?php echo e(number_format($percentual, 1)); ?>% do total
                                            </p>
                                        </div>
                                    </div>
                                    <div class="text-right">
                                        <p class="text-lg font-bold text-gray-900"><?php echo e($dia['total']); ?></p>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        const labels = <?php echo json_encode($diasLabels, 15, 512) ?>;
        const valores = <?php echo json_encode($diasValores, 15, 512) ?>;
...
<?php /**PATH /var/www/pagby/resources/views/livewire/dias-pico.blade.php ENDPATH**/ ?>