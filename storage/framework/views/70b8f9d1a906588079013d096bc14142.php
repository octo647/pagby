    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
                            ...
                            <div class="space-y-3">
                                ...
                                <button wire:click="selectEmployee(<?php echo e($employee['id']); ?>)" 
                                        class="w-full text-left p-3 rounded-lg border transition-all duration-200 hover:shadow-md
                                               <?php echo e($selectedEmployeeId == $employee['id'] ? 'bg-gradient-to-r from-indigo-50 to-purple-50 border-indigo-300 shadow-md' : 'bg-white border-gray-200 hover:border-indigo-300'); ?>">
                                    <div class="flex items-center space-x-3">
                                        <div class="flex-shrink-0">
                                            <img class="w-10 h-10 rounded-full object-cover border-2 
                                                       <?php echo e($selectedEmployeeId == $employee['id'] ? 'border-indigo-400' : 'border-gray-200'); ?>" 
                                                 src="<?php echo e(tenant_asset($employee['photo'])); ?>" 
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <div class="flex items-center gap-2">
                                                <p class="text-sm font-medium <?php echo e($selectedEmployeeId == $employee['id'] ? 'text-indigo-800' : 'text-gray-900'); ?> truncate">
                                            ...
                                            <p class="text-xs <?php echo e($selectedEmployeeId == $employee['id'] ? 'text-indigo-600' : 'text-gray-500'); ?>">
                                                <?php echo e(count($employee['services'])); ?> serviços configurados
                                            </p>
                                        </div>
                                        <?php if($selectedEmployeeId == $employee['id']): ?>
                                        <div class="flex-shrink-0">
            ...
            <div class="lg:col-span-3">
                            ...
                            <div class="bg-gradient-to-r from-indigo-500 to-purple-600 px-6 py-6">
                                <div class="flex items-center space-x-4">
                                    <img class="w-16 h-16 rounded-full object-cover border-4 border-white shadow-lg" 
                                         src="<?php echo e(tenant_asset($employee['photo'])); ?>" 
                                         alt="<?php echo e($employee['name']); ?>"
                                         onerror="this.src='https://ui-avatars.com/api/?name=<?php echo e(urlencode($employee['name'])); ?>&background=ffffff&color=6366f1&size=128'">
                                    <div>
                                        <h2 class="text-2xl font-bold text-white"><?php echo e($employee['name']); ?></h2>
                    ...
                    <?php else: ?>
                        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
                            <div class="text-center">
                                ...
                                <p class="text-gray-500"><?php echo e(__('Funcionário não encontrado')); ?></p>
                            </div>
                        </div>
                    <?php endif; ?>
                <?php else: ?>
                ...
                <?php if($selectedEmployeeId && $employee): ?>
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                        <div class="px-6 py-4 bg-gradient-to-r from-gray-50 to-white border-b border-gray-200">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500 mt-1">Marque os serviços que <?php echo e($employee['name']); ?> pode executar</p>
                                </div>
                                <div class="text-sm text-gray-500">
                                    <?php echo e(count(array_filter($services, fn($s) => in_array($s['id'], $employee['services'])))); ?>/<?php echo e(count($services)); ?> serviços ativos
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="min-w-full">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        ?>
                                        <tr class="hover:bg-gray-200 transition-colors <?php echo e($isActive ? 'bg-blue-50' : ''); ?>">
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex items-center">
                                                    <div class="flex-shrink-0 w-2 h-2 rounded-full mr-3 <?php echo e($isActive ? 'bg-green-400' : 'bg-gray-300'); ?>"></div>
                                                    <div>
                                                        <div class="text-sm font-medium text-gray-900"><?php echo e($service['service']); ?></div>
                                                        <?php if($customDuration): ?>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                                <label class="relative inline-flex items-center cursor-pointer">
                                                    <input type="checkbox"
                                                           wire:click="changeService(<?php echo e($service['id']); ?>, <?php echo e($employee['id']); ?>)"
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-gray-100 text-gray-800">
                                                    ...
                                                    <?php echo e($serviceModel?->time ?? 30); ?> min
                                                </span>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                                <?php if($isActive): ?>
                                                    <div class="flex flex-col items-center space-y-2">
                                                        <div class="relative">
                                                            <input type="number" 
                                                                min="1" 
                                                                max="300"
                                                                placeholder="<?php echo e($serviceModel?->time ?? 30); ?>"
                                                                value="<?php echo e($customDuration); ?>"
                                                                wire:blur="updateCustomDuration(<?php echo e($service['id']); ?>, <?php echo e($employee['id']); ?>, $event.target.value)"
                                                        ...
                                                        <?php if($customDuration): ?>
                                                            <span class="text-blue-600 font-medium bg-blue-50 px-2 py-1 rounded">
                                                                <?php echo e($customDuration); ?> min configurado
                                                            </span>
                                                        <?php else: ?>
                                                            <span class="text-xs text-gray-500">usando padrão (<?php echo e($serviceModel?->time ?? 30); ?>min)</span>
                                                        <?php endif; ?>
                                                    </div>
                                                <?php else: ?>
                        ...
                        <div class="block lg:hidden p-4 space-y-4">
                            <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                ?>
                                <div class="border border-gray-200 rounded-lg p-4 <?php echo e($isActive ? 'bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200' : 'bg-white'); ?>">
                                    <div class="flex items-center justify-between mb-3">
                                        <div class="flex items-center space-x-3">
                                            <div class="w-3 h-3 rounded-full <?php echo e($isActive ? 'bg-green-400' : 'bg-gray-200'); ?>"></div>
                                            <h4 class="font-medium text-gray-900"><?php echo e($service['service']); ?></h4>
                                        </div>
                                        <label class="relative inline-flex items-center cursor-pointer">
                                            <input type="checkbox"
                                                   wire:click="changeService(<?php echo e($service['id']); ?>, <?php echo e($employee['id']); ?>)"
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        <div class="text-center p-3 bg-gray-50 rounded-lg">
                                            ...
                                            <p class="text-sm font-bold text-gray-900"><?php echo e($serviceModel?->time ?? 30); ?> min</p>
                                        </div>
                                        ...
                                        <div class="text-center">
                                            ...
                                            <?php if($customDuration): ?>
                                                <p class="text-xs text-blue-600 font-medium mt-1"><?php echo e($customDuration); ?> min</p>
                                            <?php endif; ?>
                                        </div>
                                        <?php else: ?>
...
<?php /**PATH /var/www/pagby/resources/views/livewire/proprietario/employee-service.blade.php ENDPATH**/ ?>