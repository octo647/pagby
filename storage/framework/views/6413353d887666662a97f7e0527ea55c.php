...
<body class="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen flex items-center justify-center p-4">
    <div class="max-w-2xl w-full">
        <div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div class="px-8 py-10">
                ...
                <div class="bg-gray-50 rounded-xl p-6 mb-6">
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="font-semibold text-gray-800"><?php echo e($payment->plan ?? 'Plano Premium'); ?></span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-gray-600">Valor:</span>
                            <span class="font-semibold text-gray-800">R$ <?php echo e(number_format($payment->amount ?? 0, 2, ',', '.')); ?></span>
                        </div>
                        <div class="flex justify-between items-center">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <span class="font-mono text-sm text-gray-700"><?php echo e($subscription_id); ?></span>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <?php if($tenant_id): ?>
                    <a href="https://<?php echo e($tenant_id); ?>.pagby.com.br/planos" 
                    ...
                    <?php endif; ?>
                    <a href="https://<?php echo e($tenant_id ?? 'magic-club'); ?>.pagby.com.br" 
        ...
        <script>
            ...
            setTimeout(() => {
                window.location.href = "https://<?php echo e($tenant_id ?? 'magic-club'); ?>.pagby.com.br/planos";
            }, 30000);
        </script>
    </div>
</body>
</html>
<?php /**PATH /var/www/pagby/resources/views/assinatura/wait.blade.php ENDPATH**/ ?>