    ...
    <div class="flex-1 flex flex-col items-center justify-center text-center px-4 py-10">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="mb-8">
                ...
                <p class="text-xl text-white/80">Sua assinatura do Plano <?php echo e($plan_name ?? 'Personalizado'); ?> foi ativada com sucesso!</p>
            </div>
                ...
                <div class="grid md:grid-cols-2 gap-6 text-left">
                    <div class="space-y-4">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="font-bold text-purple-600 capitalize">
                                <?php echo e($plan_name ?? 'Não disponível'); ?>
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <span class="font-semibold text-gray-800">
                                <?php echo e(Auth::user()?->name ?? 'Assinante'); ?>
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-green-100 text-green-800">
                                ...
                                <?php echo e($price ? 'R$ ' . $price : 'Não disponível'); ?>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-gray-800"><?php echo e(now()->format('d/m/Y H:i')); ?></span>
                        </div>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                ...
                <a href="<?php echo e(route('tenant.dashboard', ['tabelaAtiva' => 'planos-de-assinatura'])); ?>" 
...
<?php endif; ?><?php /**PATH /var/www/pagby/resources/views/tenant-assinatura/success.blade.php ENDPATH**/ ?>