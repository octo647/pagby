...
<head>
    ...
    <title><?php echo e(tenant()->fantasy_name ?? 'Belle Éclat'); ?> - Salão de Beleza</title>
    ...
    <style>
        ...
        * {
        ...
        /* Hero Section */
        .hero {
            background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('images/Templates/Salões/Moderno/hero.jpeg') no-repeat center center/cover;
...
<body>
    ...
    <header>
        <div class="container">
            <nav class="navbar">
                <div class="logo">
                    <img src="<?php echo e(tenant()->logo ?? ''); ?>" alt="<?php echo e(tenant()->fantasy_name ?? 'Belle Éclat'); ?>" style="width:54px; height:54px; object-fit:cover; border-radius:50%; box-shadow:0 2px 8px #d4af37a0;">
                    <span class="salon-name-navbar"><?php echo e(tenant()->fantasy_name ?? 'Belle Éclat'); ?></span>
                </div>
                <ul class="nav-links">
    ...
    <section class="hero" id="home">
        <div class="container">
            <div class="hero-content">
                ...
                <p>No <?php echo e(tenant()->fantasy_name ?? 'Belle Éclat'); ?>, oferecemos tratamentos exclusivos para realçar sua beleza única com técnicas modernas e produtos de alta qualidade.</p>
            ...
            <div class="services-grid">
                <div class="service-card">
                    <div class="service-img">
                        <img src="/images/Templates/Salões/Moderno/escova.jpeg" alt="Corte de Cabelo">
                    </div>
                ...
                <div class="service-card">
                    <div class="service-img">
                        <img src="/images/Templates/Salões/Moderno/coloracao.jpeg" alt="Coloração">
                    </div>
                    <div class="service-info">
                        <h3>Coloração</h3>
                ...
                <div class="service-card">
                    <div class="service-img">
                        <img src="/images/Templates/Salões/Moderno/manicure.jpeg" alt="Manicure e Pedicure">
                    </div>
                    <div class="service-info">
                ...
                <div class="service-card">
                    <div class="service-img">
                        <img src="/images/Templates/Salões/Moderno/facial.jpeg" alt="Tratamentos Faciais">
                    </div>
                    <div class="service-info">
                ...
                <div class="service-card">
                    <div class="service-img">
                        <img src="/images/Templates/Salões/Moderno/maquiagem.jpeg" 
                        alt="Maquiagem">
                ...
                <div class="service-card">
                    <div class="service-img">
                        <img src="/images/Templates/Salões/Moderno/depilacao.jpeg" alt="Depilação">
                    </div>
                    <div class="service-info">
                        <h3>Depilação</h3>
        ...
        <div class="container">
            <div class="about-content">
                ...
                <div class="about-text">
                    <h2>Sobre o <?php echo e(tenant()->fantasy_name ?? 'Belle Éclat'); ?></h2>
                    <p>Há mais de 10 anos no mercado, o <?php echo e(tenant()->fantasy_name ?? 'Belle Éclat'); ?> se consolidou como referência em beleza e bem-estar. Nossa missão é proporcionar uma experiência única e personalizada para cada cliente.</p>
                    ...
                    <p>No <?php echo e(tenant()->fantasy_name ?? 'Belle Éclat'); ?>, acreditamos que a beleza vai além da estética - é sobre autoestima, confiança e bem-estar. Por isso, nos dedicamos a criar um ambiente acolhedor onde você possa relaxar e se sentir especial.</p>
            ...
            <div class="testimonials-grid">
                <div class="testimonial-card">
                    <div class="testimonial-text">
                        "Adorei a experiência no <?php echo e(tenant()->fantasy_name ?? 'Belle Éclat'); ?>! A equipe é super atenciosa e o resultado do meu corte ficou incrível. Com certeza voltarei!"
                    </div>
            ...
            <div class="contact-content">
                <div class="contact-info">
                    ...
                    <div class="contact-details">
                        <p>📍 <?php echo e(tenant()->address ?? 'Rua das Flores, 123 - Centro, São Paulo - SP'); ?></p>
                        <p>📞 <?php echo e(tenant()->phone ?? '(11) 3456-7890'); ?></p>
                        <p>📱 <?php echo e(tenant()->whatsapp ?? '(11) 98765-4321'); ?></p>
                        <p>✉️ <?php echo e(tenant()->email ?? 'contato@belleeclat.com.br'); ?></p>
                    </div>
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-column">
                    <h3><?php echo e(tenant()->fantasy_name ?? 'Belle Éclat'); ?></h3>
            ...
            <div class="copyright">
                <p>&copy; 2023 <?php echo e(tenant()->fantasy_name ?? 'Belle Éclat'); ?> - Todos os direitos reservados</p>
            </div>
        </div>
    </footer>
...
<?php /**PATH /home/helder/projetos/pagby/resources/views/tenants/labelle/home.blade.php ENDPATH**/ ?>