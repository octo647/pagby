<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-100">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-blue-600"><?php echo e(number_format($totalClientes)); ?></p>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-100">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-emerald-600"><?php echo e($taxaRetencao); ?>%</p>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-100">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-green-600"><?php echo e(number_format($totalNovos)); ?></p>
                        <div class="flex items-center mt-1">
                            <?php if($tendenciaNovos > 0): ?>
                                <svg class="w-4 h-4 text-green-500 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path>
                                </svg>
                                <span class="text-sm text-green-600">+<?php echo e($tendenciaNovos); ?>%</span>
                            <?php elseif($tendenciaNovos < 0): ?>
                                <svg class="w-4 h-4 text-red-500 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 17h8m0 0V9m0 8l-8-8-4 4-6-6"></path>
                                </svg>
                                <span class="text-sm text-red-600"><?php echo e($tendenciaNovos); ?>%</span>
                            <?php else: ?>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-100">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-purple-600"><?php echo e($mediaNovosPerMes); ?></p>
            ...
            <div class="lg:col-span-2 bg-white rounded-2xl p-6 shadow-lg border border-slate-100 hover:shadow-xl transition-all duration-300">
                ...
                <div class="flex flex-wrap items-center justify-between mt-4 pt-4 border-t border-slate-100">
                    ...
                    <div class="text-xs text-slate-400 flex items-center space-x-2">
                        ...
                        <span>Período: <?php echo e(now()->subMonths(11)->format('m/Y')); ?> - <?php echo e(now()->format('m/Y')); ?></span>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white rounded-2xl p-6 shadow-lg border border-slate-100">
                    ...
                    <div class="space-y-4">
                        <div class="flex justify-between items-center p-3 bg-slate-50 rounded-lg">
                            ...
                            <span class="font-bold text-green-600"><?php echo e(number_format($totalNovos)); ?></span>
                        </div>
                        
                        <div class="flex justify-between items-center p-3 bg-slate-50 rounded-lg">
                            <span class="text-sm text-slate-600">Total Recorrentes</span>
                            <span class="font-bold text-blue-600"><?php echo e(number_format($totalRecorrentes)); ?></span>
                        </div>
                        ...
                        <div class="flex justify-between items-center p-3 bg-gradient-to-r from-emerald-50 to-blue-50 rounded-lg border">
                            ...
                            <span class="font-bold text-lg text-emerald-600"><?php echo e($taxaRetencao); ?>%</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="space-y-3">
                        <div class="p-3 bg-slate-50 rounded-lg">
                            <div class="flex justify-between items-center mb-1">
                                ...
                                <span class="text-sm font-bold text-slate-900"><?php echo e($mediaNovosPerMes); ?></span>
                            </div>
                            <div class="w-full bg-slate-200 rounded-full h-1.5">
                                <div class="bg-gradient-to-r from-green-400 to-green-500 h-1.5 rounded-full" style="width: <?php echo e($totalNovos > 0 ? min(($mediaNovosPerMes / max($retencaoNovos)) * 100, 100) : 0); ?>%"></div>
                            </div>
                        </div>
                        ...
                        <div class="p-3 bg-slate-50 rounded-lg">
                            <div class="flex justify-between items-center mb-1">
                                ...
                                <span class="text-sm font-bold text-slate-900"><?php echo e($mediaRecorrentesPerMes); ?></span>
                            </div>
                            <div class="w-full bg-slate-200 rounded-full h-1.5">
                                <div class="bg-gradient-to-r from-blue-400 to-blue-500 h-1.5 rounded-full" style="width: <?php echo e($totalRecorrentes > 0 ? min(($mediaRecorrentesPerMes / max($retencaoRecorrentes)) * 100, 100) : 0); ?>%"></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="space-y-4">
                        <div class="p-3 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg border border-green-200">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="text-sm font-bold text-green-800"><?php echo e($melhorMes); ?></span>
                            </div>
                            <p class="text-xs text-green-600 mt-1"><?php echo e(max($retencaoNovos)); ?> novos clientes</p>
                        </div>
                        ...
                        <div class="p-3 bg-gradient-to-r from-red-50 to-orange-50 rounded-lg border border-red-200">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="text-sm font-bold text-red-800"><?php echo e($piorMes); ?></span>
                            </div>
                            <p class="text-xs text-red-600 mt-1"><?php echo e(min($retencaoNovos)); ?> novos clientes</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (ctx) {
                const labels = <?php echo json_encode($retencaoLabels, 15, 512) ?>;
                const novos = <?php echo json_encode($retencaoNovos, 15, 512) ?>;
                const recorrentes = <?php echo json_encode($retencaoRecorrentes, 15, 512) ?>;
...
<?php /**PATH /var/www/pagby/resources/views/livewire/proprietario/clientes-novos-antigos.blade.php ENDPATH**/ ?>