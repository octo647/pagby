...
<nav x-data="{ open: false }" class="bg-gradient-to-r from-blue-100 via-white to-pink-100 border-b border-gray-200 shadow-lg">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 items-center">
            ...
            <!-- Logo -->
            <a href="<?php echo e(route('tenant.dashboard')); ?>" class="flex items-center gap-2">
                <?php if (isset($component)) { $__componentOriginal8892e718f3d0d7a916180885c6f012e7 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8892e718f3d0d7a916180885c6f012e7 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.application-logo','data' => ['class' => 'block h-9 w-auto drop-shadow']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'block h-9 w-auto drop-shadow']); ?>
...
<?php $component->withAttributes(['align' => 'right','width' => '48']); ?>
                     <?php $__env->slot('trigger', null, []); ?> 
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-700 bg-gradient-to-r from-white to-blue-50 hover:text-pink-600 focus:outline-none transition ease-in-out duration-150 shadow">
                            ...
                            ?>
                                <img src="<?php echo e($isExternalPhoto ? $user ->photo : ($user->photo ? tenant_asset(Auth::user()->photo) : '')); ?>"  alt="Foto de <?php echo e(Auth::user()->name); ?>" class="h-8 w-8 rounded-full border-2 border-blue-300 shadow"
                                <?php if(!$user->photo): ?> style="display:none;" <?php endif; ?>>
                            <?php else: ?>
                                <img src="<?php echo e(global_asset('images/default-user.png')); ?>" title="Atualize sua foto de perfil" alt="Atualize a foto" class="h-8 w-8 rounded-full border-2 border-gray-300">
                                <div class="ml-2 text-xs text-gray-500"><?php echo e(Auth::user()->name ?? 'Visitante'); ?></div> 
                            <?php endif; ?>
                            <div class="ml-2">
    ...
    <div x-show="open" @click.self="open = false" class="fixed top-0 left-0 h-full w-72 z-50 bg-white bg-opacity-20 transition-opacity duration-300">
        <div class="bg-gradient-to-b from-blue-50 via-white to-pink-50 w-72 h-full max-h-screen overflow-y-auto shadow-2xl p-6 rounded-r-2xl border-r border-blue-200 animate-slidein">
            ...
            <div class="mb-8 flex flex-col items-center gap-2">
                <?php if(!empty(Auth::user()->photo)): ?>
                    <?php if($isExternalPhoto): ?>
                        <img src="<?php echo e(Auth::user()->photo); ?>" alt="Foto de <?php echo e(Auth::user()->name); ?>" class="h-16 w-16 rounded-full border-4 border-blue-200 shadow">
                    <?php else: ?>
                        <img src="<?php echo e(tenant_asset(Auth::user()->photo)); ?>" alt="Foto de <?php echo e(Auth::user()->name); ?>" class="h-16 w-16 rounded-full border-4 border-blue-200 shadow">
                    <?php endif; ?>
                <?php else: ?>
                    <img src="<?php echo e(global_asset('images/default-user.png')); ?>" title="Atualize sua foto de perfil" alt="Atualize a foto" class="h-16 w-16 rounded-full border-4 border-gray-200">
                <?php endif; ?>
                <div class="font-semibold text-blue-700 text-lg"><?php echo e(Auth::user()->name ?? 'Visitante'); ?></div>
            ...
            <?php if($isProprietario && $isFuncionario): ?>
                <?php
                    $query = request()->query();
                ...
                <div class="flex justify-center gap-2 mb-6">
                    <a href="<?php echo e(route('tenant.dashboard', ['tabelaAtiva' => 'gerenciar-comandas', 'menu' => 'proprietario'])); ?>" class="px-3 py-1 rounded-full text-sm font-semibold border transition-all duration-150 <?php echo e($menuSelecionado === 'proprietario' ? 'bg-blue-200 text-blue-900 border-blue-400' : 'bg-white text-gray-600 border-gray-300 hover:bg-blue-50'); ?>">
                        Proprietário
                    </a>
                    <a href="<?php echo e(route('tenant.dashboard', ['tabelaAtiva' => 'agenda', 'menu' => 'funcionario'])); ?>" class="px-3 py-1 rounded-full text-sm font-semibold border transition-all duration-150 <?php echo e($menuSelecionado === 'funcionario' ? 'bg-pink-200 text-pink-900 border-pink-400' : 'bg-white text-gray-600 border-gray-300 hover:bg-pink-50'); ?>">
                        Funcionário
                    </a>
                </div>
            <?php endif; ?>
            ...
            ?>
            <?php if($isAdmin): ?>
                <?php $__currentLoopData = $menuAdmin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if (isset($component)) { $__componentOriginald69b52d99510f1e7cd3d80070b28ca18 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald69b52d99510f1e7cd3d80070b28ca18 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.responsive-nav-link','data' => ['href' => route('tenant.dashboard', ['tabelaAtiva' => $item['tabelaAtiva'], 'menu' => $menuSelecionado]),'active' => request()->input('tabelaAtiva') === $item['tabelaAtiva'] && request()->input('menu', $menuSelecionado) === 'admin']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('tenant.dashboard', ['tabelaAtiva' => $item['tabelaAtiva'], 'menu' => $menuSelecionado])),'active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->input('tabelaAtiva') === $item['tabelaAtiva'] && request()->input('menu', $menuSelecionado) === 'admin')]); ?>
                        <?php echo $item['icon'] ?? ''; ?>
...
<?php endif; ?>
            ...
            <?php if(($menuSelecionado === 'proprietario' && $isProprietario) || ($isProprietario && !$isFuncionario)): ?>
                <?php
                    $menuProprietario = [
                        ...
                        ['tabelaAtiva' => 'dashboard-fidelidade', 'label' => 'Fidelidade & Produtos', 'icon' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" class="size-5 inline mr-1 align-middle"><path d="M12 4.5l2.5 5.5h6l-4.5 4 1.5 6-5.5-3.5-5.5 3.5 1.5-6-4.5-4h6l2.5-5.5z" fill="#F472B6"/><circle cx="12" cy="12" r="3" fill="#FBBF24"/></svg>'],
                    ];
                ...
                <?php if(!tenant()->onboarding_completed): ?>
                    <div class="mb-4 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-lg p-4 shadow-lg">
                        <a href="<?php echo e(route('onboarding')); ?>" class="block text-white hover:opacity-90 transition-opacity">
                ...
                <?php $__currentLoopData = $menuProprietario; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if (isset($component)) { $__componentOriginald69b52d99510f1e7cd3d80070b28ca18 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald69b52d99510f1e7cd3d80070b28ca18 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.responsive-nav-link','data' => ['href' => route('tenant.dashboard', ['tabelaAtiva' => $item['tabelaAtiva'], 'menu' => $menuSelecionado]),'active' => request()->input('tabelaAtiva') === $item['tabelaAtiva'] && request()->input('menu', $menuSelecionado) === 'proprietario']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('responsive-nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('tenant.dashboard', ['tabelaAtiva' => $item['tabelaAtiva'], 'menu' => $menuSelecionado])),'active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->input('tabelaAtiva') === $item['tabelaAtiva'] && request()->input('menu', $menuSelecionado) === 'proprietario')]); ?>
                        <?php echo $item['icon'] ?? ''; ?>
...
<?php endif; ?>
                ...
                <div x-data="{ openSub: false }" class="mb-2">
                    <button @click="openSub = !openSub" class="flex items-center w-full px-4 py-2 text-left hover:bg-gray-100 rounded">
                        <?php echo $menuCadastros['icon']; ?>

                        <span><?php echo e($menuCadastros['label']); ?></span>
                    ...
                    <div x-show="openSub" class="pl-6 mt-1 space-y-1">
                        <?php $__currentLoopData = $menuCadastros['submenu']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subitem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if (isset($component)) { $__componentOriginald69b52d99510f1e7cd3d80070b28ca18 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald69b52d99510f1e7cd3d80070b28ca18 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.responsive-nav-link','data' => ['href' => route('tenant.dashboard', ['tabelaAtiva' => $subitem['tabelaAtiva'], 'menu' => $menuSelecionado]),'active' => request()->input('tabelaAtiva') === $subitem['tabelaAtiva'] && request()->input('menu', $menuSelecionado) === 'proprietario']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('responsive-nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('tenant.dashboard', ['tabelaAtiva' => $subitem['tabelaAtiva'], 'menu' => $menuSelecionado])),'active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->input('tabelaAtiva') === $subitem['tabelaAtiva'] && request()->input('menu', $menuSelecionado) === 'proprietario')]); ?>
...
<?php endif; ?>
                ...
                <div x-data="{ openSub: false }" class="mb-2">
                    <button @click="openSub = !openSub" class="flex items-center w-full px-4 py-2 text-left hover:bg-gray-100 rounded">
                        <?php echo $menuRelatorios['icon']; ?>

                        <span><?php echo e($menuRelatorios['label']); ?></span>
                        <svg :class="{'rotate-90': openSub}" class="ml-auto h-4 w-4 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                        </svg>
                    </button>
                    <div x-show="openSub" class="pl-6 mt-1 space-y-1">
                        <?php $__currentLoopData = $menuRelatorios['submenu']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subitem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if (isset($component)) { $__componentOriginald69b52d99510f1e7cd3d80070b28ca18 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald69b52d99510f1e7cd3d80070b28ca18 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.responsive-nav-link','data' => ['href' => route('tenant.dashboard', ['tabelaAtiva' => $subitem['tabelaAtiva'], 'menu' => $menuSelecionado]),'active' => request()->input('tabelaAtiva') === $subitem['tabelaAtiva'] && request()->input('menu', $menuSelecionado) === 'proprietario']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('responsive-nav-link'); ?>
...
<?php endif; ?>
                ...
                <div x-data="{ openSub: false }" class="mb-2">
                    <button @click="openSub = !openSub" class="flex items-center w-full px-4 py-2 text-left hover:bg-gray-100 rounded">
                        <?php echo $menuEstatisticas['icon']; ?>

                        <span><?php echo e($menuEstatisticas['label']); ?></span>
                        <svg :class="{'rotate-90': openSub}" class="ml-auto h-4 w-4 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                        </svg>
                    </button>
                    <div x-show="openSub" class="pl-6 mt-1 space-y-1">
                        <?php $__currentLoopData = $menuEstatisticas['submenu']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subitem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if (isset($component)) { $__componentOriginald69b52d99510f1e7cd3d80070b28ca18 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald69b52d99510f1e7cd3d80070b28ca18 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.responsive-nav-link','data' => ['href' => route('tenant.dashboard', ['tabelaAtiva' => $subitem['tabelaAtiva'], 'menu' => $menuSelecionado]),'active' => request()->input('tabelaAtiva') === $subitem['tabelaAtiva'] && request()->input('menu', $menuSelecionado) === 'proprietario']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('responsive-nav-link'); ?>
...
<?php endif; ?>
            ...
            <?php if(($menuSelecionado === 'funcionario' && $isFuncionario) || ($isFuncionario && !$isProprietario)): ?>
                <?php
                    $menuFuncionario = [
                ...
                <?php $__currentLoopData = $menuFuncionario; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if (isset($component)) { $__componentOriginald69b52d99510f1e7cd3d80070b28ca18 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald69b52d99510f1e7cd3d80070b28ca18 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.responsive-nav-link','data' => ['href' => route('tenant.dashboard', ['tabelaAtiva' => $item['tabelaAtiva'], 'menu' => $menuSelecionado]),'active' => request()->input('tabelaAtiva') === $item['tabelaAtiva'] && request()->input('menu', $menuSelecionado) === 'funcionario']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('responsive-nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('tenant.dashboard', ['tabelaAtiva' => $item['tabelaAtiva'], 'menu' => $menuSelecionado])),'active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->input('tabelaAtiva') === $item['tabelaAtiva'] && request()->input('menu', $menuSelecionado) === 'funcionario')]); ?>
                        <?php echo $item['icon']; ?>
...
<?php endif; ?>
                ...
                <div x-data="{ openSub: false }" class="mb-2">
                    <button @click="openSub = !openSub" class="flex items-center w-full px-4 py-2 text-left hover:bg-gray-100 rounded">
                        <?php echo $menuHonorarios['icon']; ?>

                        <span><?php echo e($menuHonorarios['label']); ?></span>
                        <svg :class="{'rotate-90': openSub}" class="ml-auto h-4 w-4 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                        </svg>
                    </button>
                    <div x-show="openSub" class="pl-6 mt-1 space-y-1">
                        <?php $__currentLoopData = $menuHonorarios['submenu']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subitem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if (isset($component)) { $__componentOriginald69b52d99510f1e7cd3d80070b28ca18 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald69b52d99510f1e7cd3d80070b28ca18 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.responsive-nav-link','data' => ['href' => route('tenant.dashboard', ['tabelaAtiva' => $subitem['tabelaAtiva'], 'menu' => $menuSelecionado]),'active' => request()->input('tabelaAtiva') === $subitem['tabelaAtiva'] && request()->input('menu', $menuSelecionado) === 'funcionario']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('responsive-nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('tenant.dashboard', ['tabelaAtiva' => $subitem['tabelaAtiva'], 'menu' => $menuSelecionado])),'active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->input('tabelaAtiva') === $subitem['tabelaAtiva'] && request()->input('menu', $menuSelecionado) === 'funcionario')]); ?>
                                <?php echo $subitem['icon']; ?>
...
<?php endif; ?>
            ...
            <?php if($isCliente): ?>
                ...
                <?php $__currentLoopData = $menuCliente; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if (isset($component)) { $__componentOriginald69b52d99510f1e7cd3d80070b28ca18 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald69b52d99510f1e7cd3d80070b28ca18 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.responsive-nav-link','data' => ['href' => route('tenant.dashboard', ['tabelaAtiva' => $item['tabelaAtiva'], 'menu' => $menuSelecionado]),'active' => request()->input('tabelaAtiva') === $item['tabelaAtiva'] && request()->input('menu', $menuSelecionado) === 'cliente']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('responsive-nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('tenant.dashboard', ['tabelaAtiva' => $item['tabelaAtiva'], 'menu' => $menuSelecionado])),'active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->input('tabelaAtiva') === $item['tabelaAtiva'] && request()->input('menu', $menuSelecionado) === 'cliente')]); ?>
                        <?php echo $item['label']; ?>
...
</nav><?php /**PATH /home/helder/projetos/pagby/resources/views/layouts/navigation.blade.php ENDPATH**/ ?>