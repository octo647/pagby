...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        <!--[if BLOCK]><![endif]--><?php if(count($funcionarios) == 0): ?>
        ...
        <?php else: ?>
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <!--[if BLOCK]><![endif]--><?php if(is_null($choosedEmployee)): ?>
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $funcionarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $funcionario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div wire:key="<?php echo e($index); ?>" 
                                     ...
                                     wire:click="selectProfessional('<?php echo e($funcionario->id); ?>')">
                                    ...
                                    <div class="flex flex-col items-center text-center">
                                        <div class="relative mb-4">
                                                ...
                                                <img class="w-20 h-20 rounded-full object-cover border-4 border-white shadow-lg group-hover:scale-110 transition-transform duration-300" 
                                                    src="<?php echo e($isExternal ? $funcionario->photo : tenant_asset($funcionario->photo)); ?>" 
                                                    alt="Foto <?php echo e($funcionario->name); ?>">
                                ...
                                <div class="flex flex-col items-center">
                                    <div class="relative mb-4">
                                        ...
                                        <img class="w-24 h-24 rounded-full object-cover border-4 border-green-400 shadow-lg" 
                                            src="<?php echo e($isExternal ? $selectedUser->photo : tenant_asset($selectedUser->photo)); ?>" 
                                            alt="Foto <?php echo e($selectedUser->name); ?>">
                                    ...
                                    <h3 class="font-bold text-xl text-gray-900 mb-2"><?php echo e($selectedUser->name); ?></h3>
        ...
        <!--[if BLOCK]><![endif]--><?php if(!is_null($choosedEmployee)): ?>
            ...
            <div class="mt-8 bg-white rounded-2xl shadow-lg overflow-hidden">
                ...
                <div class="px-6 py-4 bg-gradient-to-r from-green-500 to-emerald-600">
                    <div class="flex items-center space-x-4">
                        <img class="w-16 h-16 rounded-full object-cover border-4 border-white shadow-lg" 
                             src="<?php echo e(tenant_asset($user->photo)); ?>" 
                             alt="Foto de <?php echo e($name); ?>">
                        <div>
                            <h2 class="text-xl font-semibold text-white">✅ Profissional Selecionado</h2>
                            <p class="text-green-100 text-lg font-medium"><?php echo e($name); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6">
                    ...
                    <div class="space-y-3">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $user->services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
                            <label for="checkbox-<?php echo e($service->id); ?>" 
                                ...
                                <div class="relative flex-shrink-0">
                                    <input wire:model="chosen_services" 
                                           id="checkbox-<?php echo e($service->id); ?>" 
                                           class="sr-only" 
                                           type="checkbox" 
                                           name="service" 
                                ...
                                <div class="ml-4 flex-1 flex items-center justify-between">
                                    ...
                                    <div class="text-right">
                                        <div class="text-xl font-bold text-green-600">R$ <?php echo e($service->price); ?></div>
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['semservico'];
...
<?php /**PATH /home/helder/projetos/pagby/resources/views/livewire/cliente/choose-employee.blade.php ENDPATH**/ ?>