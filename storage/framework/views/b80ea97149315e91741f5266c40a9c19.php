...
<head>
    ...
    <title><?php echo e(tenant()->fantasy_name ?? 'Barbearia Vibe'); ?> - Estilo Moderno</title>
...
<body>
    ...
    <header>
        <div class="logo">
            ...
            <div class="logo-text"><?php echo e(tenant()->fantasy_name ?? 'VIBE BARBER'); ?></div>
        </div>
        ...
        <button class="cta-header" onclick="window.location.href='<?php echo e(route('login')); ?>'">Agendar</button>
    </header>
    ...
    <section class="hero" id="home">
        ...
        <div class="hero-content">
            ...
            <p>Na <?php echo e(tenant()->fanatasy_name ?? 'Vibe Barber'); ?>, combinamos técnicas tradicionais com as últimas tendências para criar looks únicos que expressam sua personalidade. Experiência premium em um ambiente descontraído.</p>
            
            <div class="hero-buttons">
                <button class="btn-primary" onclick="window.location.href='<?php echo e(route('login')); ?>'">AGENDAR HORÁRIO</button>
    ...
    <section class="gallery" id="gallery">
        ...
        <div class="gallery-grid">
            <div class="gallery-item">
                <img src="images/Templates/Barbearias/Moderna/corte.jpeg" alt="Corte moderno">
            ...
            <div class="gallery-item">
                <img src="images/Templates/Barbearias/Moderna/produtos.jpeg" alt="Produtos premium">
                <div class="gallery-overlay">
                    <h3>PRODUTOS PREMIUM</h3>
                </div>
            </div>
            ...
            <div class="gallery-item">
                <img src="images/Templates/Barbearias/Moderna/ambiente_premium.jpeg" alt="Ambiente moderno">
                <div class="gallery-overlay">
    ...
    <section class="final-cta" id="cta">
        ...
        <button class="cta-big" onclick="window.location.href='<?php echo e(route('login')); ?>'">AGENDAR AGORA</button>
    </section>
    ...
    <footer id="contact">
        <div class="footer-content">
            <div class="footer-section">
                ...
                <div class="social-links">
                    <a href="#" class="social-link"><i class="fab fa-instagram"></i><?php echo e(tenant()->instagram); ?></a>
                    <a href="#" class="social-link"><i class="fab fa-facebook-f"></i><?php echo e(tenant()->facebook); ?></a>
                    <a href="#" class="social-link"><i class="fab fa-tiktok"></i><?php echo e(tenant()->tiktok); ?></a>
                    <a href="https://wa.me/<?php echo e(tenant()->whatsapp); ?>" class="social-link"><i class="fab fa-whatsapp"> </i></a>
                </div>
            </div>
            ...
            <div class="footer-section">
                ...
                <div class="contact-info">
                    <p><i class="fas fa-map-marker-alt"></i> <?php echo e(tenant()->address); ?></p>
                    <p><i class="fas fa-phone"></i> <?php echo e(tenant()->phone); ?></p>
                    <p><i class="fas fa-envelope"></i> <?php echo e(tenant()->email); ?></p>
                    <p><i class="fas fa-clock"></i> <?php echo e(tenant()->hours); ?></p>
                </div>
            </div>
        ...
        <div class="copyright">
            <p>&copy; 2023 <?php echo e(tenant()->fantasy_name ?? 'VIBE BARBER'); ?>. Todos os direitos reservados. | Design moderno e vibrante para uma nova geração.</p>
        </div>
    </footer>
...
<?php /**PATH /var/www/pagby/resources/Templates/Barbearias/Moderna/home.blade.php ENDPATH**/ ?>