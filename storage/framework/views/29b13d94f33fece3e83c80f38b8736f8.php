        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8 mb-8">
                ...
                <div class="flex flex-col gap-4">
                    <a href="<?php echo e(route('pagby-subscription.payment')); ?>" 
                       class="bg-gradient-to-r from-purple-600 to-pink-600 text-white py-4 px-8 rounded-lg font-bold text-lg hover:from-purple-700 hover:to-pink-700 transition-all transform hover:scale-105">
                        🚀 Continuar com <?php echo e(ucfirst($plan)); ?>
...
<?php endif; ?><?php /**PATH /var/www/pagby/resources/views/pagby-subscription/choose-plan.blade.php ENDPATH**/ ?>