...
<body>
            ...
            <div class="col-md-8">
                <div class="card shadow">
                    ...
                    <div class="card-body text-center">
                        <div class="mb-4">
                            <h6>Quase lá! 🎉</h6>
                            <p><strong><?php echo e($tenant_name); ?></strong> </p>      <p><strong>Plano:</strong> <?php echo e($plan_name); ?><br>
                            <strong>Funcionários:</strong> <?php echo e($employee_count); ?><br>
                            <strong>Valor:</strong> R$ <?php echo e(number_format($payment->amount, 2, ',', '.')); ?></p>
                        </div>
                        ...
                        <div class="mt-4">
                            <a href="<?php echo e(url('/dashboard?tabelaAtiva=planos-de-assinatura')); ?>" class="btn btn-secondary">
    ...
    function checkPaymentStatus() {
        ...
        checkInterval = setInterval(() => {
            ...
            fetch('/pagby-subscription/check-status/<?php echo e($payment->id); ?>')         
                ...
                .then(data => {
                    ...
                    if (data.status === 'RECEIVED' || data.status === 'CONFIRMED') {
                        ...
                        setTimeout(() => {
                            window.location.href = '/pagby-subscription/success_renew?payment_id=' + data.external_id + '&status=approved&external_reference=' + data.payment_id;
                        }, 2000);
...
</html><?php /**PATH /var/www/pagby/resources/views/tenant-assinatura/waitRenew.blade.php ENDPATH**/ ?>