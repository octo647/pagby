...
<head>
    ...
    <title><?php echo e(tenant()->fantasy_name ?? 'Funk Barber - Estilo da Quebrada'); ?></title>
...
<body>
    ...
    <header>
        <div class="logo">
            ...
            <div class="logo-text"><?php echo e(tenant()->fantasy_name ?? 'FUNK BARBER'); ?></div>
        </div>
        ...
        <nav>
            <ul>
                ...
                <li><a href="<?php echo e(route('login')); ?>" class="header-btn"><i class="fas fa-sign-in-alt nav-icon"></i> AGENDAR</a></li>
            </ul>
        </nav>
    ...
    <section class="hero" id="home">
        <div class="hero-content">
            <h1><?php echo e(tenant()->fantasy_name ?? 'BARBEARIA DA<br><span>QUEBRADA TOP'); ?>'</span></h1>
            ...
            <div class="hero-buttons">
                <button class="btn-whatsapp" onclick="openWhatsApp(<?php echo e(tenant()->whatsapp); ?>)">
                    <i class="fab fa-whatsapp"></i> CHAMA NO ZAP
                </button>
                <button class="btn-instagram" onclick="openInstagram(<?php echo e(tenant()->instagram); ?>)">
    ...
    <footer id="contact">
        <div class="footer-content">
            <div class="footer-section">
                <h3><?php echo e(tenant()->fantasy_name ?? 'FUNK BARBER'); ?></h3>
            ...
            <div class="footer-section">
                ...
                <div class="contact-info">
                    <p><i class="fas fa-map-marker-alt"></i> <?php echo tenant()->address.','.tenant()->number.'<br>'.tenant()->complement. ' '. tenant()->neighborhood ?? 'Rua do Funk, 150 - Favela Top'; ?></p>
                    <p><i class="fas fa-phone"></i> <?php echo e(tenant()->phone ?? '(11) 9 8888-7777'); ?></p>
        ...
        <div class="copyright">
            <p>© 2023 <?php echo e(tenant()->fantasy_name ?? 'FUNK BARBER'); ?> | Orgulho da quebrada! 🎵 "Aqui o pobre é rico e o playboy não entra" 🎵</p>
        </div>
    </footer>
    ...
    <script>
        ...
        function openWhatsApp(phone = null) {
            if (!phone) {
                phone = "<?php echo e(tenant()->whatsapp ?? tenant()->phone ?? '5511988887777'); ?>";
            }
        ...
        function openInstagram() {
            window.open("<?php echo e(tenant()->instagram ?? 'https://instagram.com/funkbarber'); ?>", '_blank');
        }
...
<?php /**PATH /var/www/pagby/resources/Templates/Barbearias/Funk/home.blade.php ENDPATH**/ ?>