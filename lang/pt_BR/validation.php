    ...
    */
    ...
    'custom' => [
        'current_password' => [
            ...
            'current_password' => 'A senha atual não está correta. Verifique e tente novamente.',
        ],
        'password' => [
            'required' => 'A nova senha é obrigatória.',
            'min' => 'A senha deve ter pelo menos :min caracteres.',
            'confirmed' => 'A confirmação da senha não confere. Digite novamente.',
        ],
        'password_confirmation' => [
            'required' => 'A confirmação da senha é obrigatória.',
            'same' => 'A confirmação deve ser igual à nova senha.',
        ],
    ],
