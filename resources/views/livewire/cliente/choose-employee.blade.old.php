...
<div id="professionals" class="">
    @if(isset($choosedEmployee))
      ...
      <div class="flex flex-col sm:flex-row items-center gap-4">
         <img class="w-24 h-24 rounded-full object-cover border" src="images/{{$choosedEmployee}}.jpeg" alt="Foto de {{$name}}">{{$name}} <br>
      ...
      <div class="text-blue-600 text-xl" id="escolha">
        ...
        <div wire:key="{{$index}}" id="professional-{{$index}}" class="flex flex-row p-6 text-sm card professional" style="width: 20rem;">
          <div class="basis-1/2 ">
            <img  onclick="selectProfessional('{{$index}}', '{{$employee['employee_id']}}')"             
            class="card-img-top" 
     ...
     <script type="text/javascript">
         ...
         window.selectProfessional = function(id, employee_id) {
            ...
            @this.call('showServices', employee_id); // Chama o método Livewire diretamente
         }
