                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-1 flex items-center space-x-4">
                                                @if(isset($branchUsers[$index]['photo']))
                                                    <img src="{{ $branchUsers[$index]['photo']->temporaryUrl() }}" 
                    ...
                    <div class="mt-3">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                @error('newEmployee.name') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="email" wire:model="newEmployee.email" id="email" 
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                                @error('newEmployee.email') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="password" wire:model="newEmployee.password" id="password" 
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                                @error('newEmployee.password') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                            </div>
                            ...
                            <div>
                                ...
                                @error('newEmployee.branch_id') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                            </div>
                        </div>
