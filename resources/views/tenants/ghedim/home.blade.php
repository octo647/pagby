...
<body>
    ...
    <section class="servicos" id="servicos">
        <div class="container">
		 ...
		 <div class="servico-card">
                    <div class="servico-img" style="background-image: url({{ url('tenants/ghedim/galeria4.jpeg') }})"></div>
                    <div class="servico-content">
                        <h3>BARBA PREMIUM</h3>
		...
		<div class="servico-card">
                    <div class="servico-img" style="background-image: url({{ url('tenants/ghedim/sobrancelha.jpeg') }})"></div>
                    <div class="servico-content">
                        <h3>SOBRANCELHA</h3>
                ...
                <div class="servico-card">
                    <div class="servico-img" style="background-image: url({{ url('tenants/ghedim/pezinho.jpeg') }})"></div>
                    <div class="servico-content">
                ...
                <div class="servico-card">
                    <div class="servico-img" style="background-image: url({{ url('tenants/ghedim/hidratacao.jpeg') }})"></div>
                    <div class="servico-content">
                        <h3>HIDRATAÇÃO</h3>
                ...
                <div class="servico-card">
                    <div class="servico-img" style="background-image: url({{ url('tenants/ghedim/mascara.jpeg') }})"></div>
                    <div class="servico-content">
                ...
                <div class="servico-card">
                    <div class="servico-img" style="background-image: url({{ url('tenants/ghedim/depilacao_nariz.jpeg') }})"></div>
                    <div class="servico-content">
                ...
                <div class="servico-card">
                    <div class="servico-img" style="background-image: url({{ url('tenants/ghedim/depilacao_ouvido.jpeg') }})"></div>
                    <div class="servico-content">
                ...
                <div class="servico-card">
                    <div class="servico-img" style="background-image: url({{ url('tenants/ghedim/depilacao_nariz_ouvido.jpeg') }})"></div>
                    <div class="servico-content">
                ...
                <div class="servico-card">
                    <div class="servico-img" style="background-image: url({{ url('tenants/ghedim/freestyle.jpeg') }})"></div>
                    <div class="servico-content">
                        <h3>FREESTYLE</h3>
                ...
                <div class="servico-card">
                    <div class="servico-img" style="background-image: url({{ url('tenants/ghedim/raspagem_barba_maquina.jpeg') }})"></div>
                    <div class="servico-content">
                ...
                <div class="servico-card">
                    <div class="servico-img" style="background-image: url({{ url('tenants/ghedim/raspagem_cabelo_maquina.jpeg') }})"></div>
                    <div class="servico-content">
    ...
    <section class="sobre" id="sobre">
        <div class="container">
            <div class="sobre-content">
                <div class="sobre-img">
                    <img src="{{ url('tenants/ghedim/fachada.jpeg')}} " alt="Espaço Premium">
                </div>
    ...
    <section class="galeria" id="galeria">
        <div class="container">
            ...
            <div class="galeria-grid">
                <div class="galeria-item"><img src="{{ url('tenants/ghedim/galeria1.jpeg') }}"></div>
                <div class="galeria-item"><img src="{{ url('images/Templates/Barbearias/Clean/barba2.jpeg') }}"></div>
                <div class="galeria-item"><img src="{{ url('tenants/ghedim/galeria3.jpeg') }}"></div>
                <div class="galeria-item"><img src="{{ url('tenants/ghedim/galeria4.jpeg') }}"></div>
            </div>
        </div>
    </section>
