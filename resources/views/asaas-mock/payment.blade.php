        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <div class="bg-gray-50 rounded-lg p-4 mb-6">
                <div class="flex justify-between items-center mb-3">
                    ...
                    <span class="font-mono bg-gray-200 px-2 py-1 rounded text-sm">{{ $payment_id }}</span>
                </div>
                <div class="flex justify-between items-center mb-3">
                    <span class="text-gray-600">Valor:</span>
                    <span class="font-bold text-lg text-green-600">R$ {{ number_format($amount, 2, ',', '.') }}</span>
                </div>
            ...
            <!-- Ações -->
            <div class="space-y-3">
                <a href="{{ route('asaas.mock.payment', ['id' => $payment_id]) }}?action=approve" 
                ...
                <a href="{{ route('pagby-subscription.success') }}?payment_id={{ $payment_id }}" 
