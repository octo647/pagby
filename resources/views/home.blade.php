...
<x-pixby-layout>
    <main class="flex-1 flex flex-col items-center justify-center text-center bg-gray-900 px-4 py-10">
        <h1 class="text-4xl font-extrabold mb-4 text-pink-600 drop-shadow">Bem-vindo ao Pixby!</h1>
        ...
        <a href="{{ route('register-tenant') }}" class="bg-gradient-to-r from-pink-600 to-indigo-600 text-white px-6 py-3 rounded-full text-lg font-bold shadow hover:from-pink-700 hover:to-indigo-700 transition mb-8">Quero meu negócio no Pixby</a>
        ...
        <div class="mt-4 bg-white/10 rounded-xl p-8 shadow max-w-2xl text-white/80">
            ...
            <p class="mb-4">Crie sua conta gratuita e descubra como o Pixby pode transformar seu negócio de beleza e bem-estar.</p>
        ...
        <div class="mt-4 mt-6 bg-white/10 rounded-xl p-8 shadow max-w-2xl text-white/80">
            <h3 class="text-xl font-bold mb-2">Por que Pixby?</h3>
            <p class="max-w-xl mx-auto">
                Pixby nasceu para simplificar a rotina de quem vive de beleza e bem-estar. Com tecnologia de ponta, segurança e facilidade, você foca no que faz de melhor: encantar seus clientes!
            </p>
        </div>
    </main>
