...
<head>
    ...
    <title>Barbearia Minimal | Estilo Essencial</title>
    ...
    <style>
        ...
        * {
        ...
        .hero-image {
            ...
            height: 100%;
            width: 50%;
            background-image: url('https://images.unsplash.com/photo-1585747860715-2ba37e788b70?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1474&q=80');
...
<body>
    ...
    <header>
        <div class="container">
            <nav class="navbar">
                <a href="#" class="logo">{{ tenant()->fantasy_name ?? 'BARBEARIA MINIMAL' }}</a>
        ...
        <div class="container">
            ...
            <div class="servicos-grid">
                <div class="servico-card">
                    <div class="servico-img" style="background-image: url({{ url('images/Barbearia3/corte1.jpeg') }})"></div>
                ...
                <div class="servico-card">
                    <div class="servico-img" style="background-image: url({{ url('images/Barbearia3/barba1.jpeg') }})"></div>
                    <div class="servico-content">
                        <h3>BARBA</h3>
                ...
                <div class="servico-card">
                    <div class="servico-img" style="background-image: url({{ url('images/Barbearia3/homem-com-barba.jpg') }})"></div>
                    <div class="servico-content">
    ...
    <section class="sobre" id="sobre">
        <div class="container">
            <div class="sobre-content">
                <div class="sobre-img">
                    <img src="{{ url('images/Barbearia3/photo.avif') }}" alt="Interior da barbearia">
                </div>
                <div class="sobre-text">
                    <h2>SOBRE NÓS</h2>
                    <p>A {{ tenant()->fantasy_name ?? 'Barbearia Minimal' }} nasceu da ideia de que menos é mais. Em um mundo cheio de excessos, buscamos oferecer uma experiência essencial, focada no que realmente importa: qualidade, precisão e sofisticação.</p>
        ...
        <div class="container">
            ...
            <div class="galeria-grid">
                <div class="galeria-item">
                    <img src="{{ url('images/Barbearia3/corte-moderno.jpeg') }}">
                </div>
                
                <div class="galeria-item">
                    <img src="{{ url('images/Barbearia3/barba2.jpeg') }}" alt="Cuidados com a barba">
                </div>
                <div class="galeria-item">
                    <img src="{{ url('images/Barbearia3/produtos.jpeg') }}" alt="Produtos de barbearia">
                </div>
                <div class="galeria-item">
                    <img src="{{ url('images/Barbearia3/corte2.jpeg') }}" alt="Ambiente da barbearia">
                </div>
                <div class="galeria-item">
                    <img src="{{ url('images/Barbearia3/corte3.jpeg') }}" alt="Ambiente da barbearia">
                </div>
                 <div class="galeria-item">
                    <img src="{{ url('images/Barbearia3/corte4.jpeg') }}" alt="Ambiente da barbearia">
                </div>
                <div class="galeria-item">
                    <img src="{{ url('images/Barbearia3/corte5.jpeg') }}" alt="Ambiente da barbearia">
                </div>
                <div class="galeria-item">
                    <img src="{{ url('images/Barbearia3/corte6.jpeg') }}" alt="Ambiente da barbearia">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="contato-content">
                <div class="contato-info">
                    ...
                    <div class="contato-item">
                        ...
                        <div class="contato-text">
                            <h4>E-MAIL</h4>
                            <p>{{ tenant()->email ?? 'contato@barbeariaminimal.com' }}</p>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-col">
                    <h4>{{ tenant()->name ?? 'BARBEARIA MINIMAL' }}</h4>
            ...
            <div class="footer-bottom">
                <p>&copy; 2023 {{ tenant()->fantasy_name ?? 'BARBEARIA MINIMAL' }}. TODOS OS DIREITOS RESERVADOS.</p>
            </div>
        </div>
    </footer>
