...
<head>
    ...
    <title>Razor Edge - Barbearia Grunge</title>
        ...
        * {
        ...
        .cta {
            ...
            background: 
                ...
                url('https://images.unsplash.com/photo-1567894340315-735d7c361db0?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80');
            background-size: cover;
            background-position: center;
            background-attachment: fixed;
            position: relative;
...
<body>
    ...
    <header>
        <div class="logo">
            ...
            <div class="logo-text">RAZOR EDGE</div>
        </div>
        ...
        <button class="header-btn" onclick="scrollToCTA()">ENTRAR NA MATILHA</button>
    </header>
    ...
    <section class="about" id="about">
        ...
        <div class="about-content">
            ...
            <div class="about-image">
                <img src="https://images.unsplash.com/photo-1622286342621-4bd786c2447c?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Interior barbearia grunge">
            </div>
        </div>
    </section>
    ...
    <section class="gallery" id="gallery">
        ...
        <div class="gallery-grid">
            <div class="gallery-item">
                <img src="https://images.unsplash.com/photo-1585747860715-2ba37e788b70?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Corte grunge">
            ...
            <div class="gallery-item">
                <img src="https://images.unsplash.com/photo-1593702275686-4b8e9be41d8a?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Barba estilo motoclube">
                <div class="gallery-overlay">
            ...
            <div class="gallery-item">
                <img src="https://images.unsplash.com/photo-1567894340315-735d7c361db0?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Ambiente underground">
                <div class="gallery-overlay">
    ...
    <section class="cta" id="cta">
        ...
        <button class="cta-btn" onclick="openBookingModal()">AGENDAR NO BATIMENTO</button>
    </section>
    ...
    <footer id="contact">
        <div class="footer-content">
            <div class="footer-section">
                ...
                <div class="social-links">
                    ...
                    <a href="#" class="social-link"><i class="fab fa-bandcamp"></i></a>
            ...
            <div class="footer-section">
                ...
                <div class="contact-info">
                    <p><i class="fas fa-map-marker-alt"></i> Rua do Underground, 666 - Centro</p>
                    <p><i class="fas fa-phone"></i> (11) 9-6666-6666</p>
                    <p><i class="fas fa-envelope"></i> sangue@razoredge.com.br</p>
                    <p><i class="fas fa-clock"></i> Seg-Sex: 12h-22h | Sáb: 10h-20h</p>
                </div>
            </div>
        ...
        <div class="copyright">
            <p>© 2023 RAZOR EDGE BARBER | Nenhum direito reservado - roube este estilo se tiver coragem.</p>
        </div>
    </footer>
