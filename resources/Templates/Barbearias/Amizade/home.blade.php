    ...
    <nav class="sticky-nav w-full py-4 bg-gray-900 shadow z-50">
        <div class="container mx-auto flex items-center justify-between px-4">
            ...
            <div class="flex items-center gap-4">
                ...
                <a href="{{ route('tenant.register') }}" class="bg-yellow-600 text-gray-900 px-4 py-2 rounded-full text-sm font-bold shadow hover:bg-yellow-700 transition">Registrar</a>
            </div>
        </div>
    </nav>
