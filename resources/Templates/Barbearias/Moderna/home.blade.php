...
<body>
    ...
    <header>
        <div class="logo">
            ...
            <div class="logo-text">{{ tenant()->fantasy_name ?? 'VIBE BARBER' }}</div>
        </div>
    ...
    <footer id="contact">
        <div class="footer-content">
            <div class="footer-section">
                ...
                <div class="social-links">
                    ...
                    <a href="#" class="social-link"><i class="fab fa-facebook-f"></i>{{ tenant()->facebook }}</a>
                    <a href="#" class="social-link"><i class="fab fa-tiktok"></i>{{ tenant()->tiktok }}</a>
                    <a href="https://wa.me/{{tenant()->whatsapp}}" class="social-link"><i class="fab fa-whatsapp"> </i></a>
                </div>
            </div>
            ...
            <div class="footer-section">
                ...
                <div class="contact-info">
                    <p><i class="fas fa-map-marker-alt"></i> {{ tenant()->address }}</p>
                    <p><i class="fas fa-phone"></i> {{ tenant()->phone }}</p>
                    <p><i class="fas fa-envelope"></i> {{ tenant()->email }}</p>
                    <p><i class="fas fa-clock"></i> {{ tenant()->hours }}</p>
                </div>
            </div>
        ...
        <div class="copyright">
            <p>&copy; 2023 {{ tenant()->fantasy_name ?? 'VIBE BARBER' }}. Todos os direitos reservados. | Design moderno e vibrante para uma nova geração.</p>
        </div>
    </footer>
