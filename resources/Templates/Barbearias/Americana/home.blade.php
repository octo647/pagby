...
<head>
    ...
    <title>{{ tenant()->fantasy_name ?? 'Barber Shop - Barbearia Americana' }}</title>
...
<body>
    ...
    <header>
        <div class="logo">
            ...
            <div class="logo-text">{!! tenant()->fantasy_name ?? 'OLD SCHOOL<span>BARBER</span>' !!}</div>
        </div>
        <nav>
            <ul>
    ...
    <footer id="contact">
        <div class="footer-content">
            <div class="footer-section">
                <h3>{!! tenant()->fantasy_name ?? 'OLD SCHOOL<span>BARBER</span>' !!}</h3>
                ...
                <div class="social-icons">
                    <a href="{!! tenant()->facebook ?? '#' !!}"><i class="fab fa-facebook-f"></i></a>
                    <a href="{!! tenant()->instagram ?? '#' !!}"><i class="fab fa-instagram"></i></a>
                    <a href="{!! tenant()->twitter ?? '#' !!}"><i class="fab fa-twitter"></i></a>
                    <a href="{!! tenant()->tiktok ?? '#' !!}"><i class="fab fa-tiktok"></i></a>
                </div>
            </div>
            <div class="footer-section">
                <h3>CONTATO</h3>
                <div class="contact-info">
                    <p><i class="fas fa-map-marker-alt"></i> {!! tenant()->address ?? 'Rua da Tradição, 123 - Centro' !!}</p>
                    <p><i class="fas fa-phone"></i> {!! tenant()->phone ?? '(11) 3456-7890' !!}</p>
                    <p><i class="fas fa-envelope"></i> {!! tenant()->email ?? 'contato@oldschoolbarber.com' !!}</p>
                    <p><i class="fas fa-clock"></i> {!! tenant()->hours ?? 'Seg-Sex: 9h-19h | Sáb: 9h-17h' !!}</p>
                </div>
            </div>
        </div>
        <div class="copyright">
            <p>&copy; 2023 {!! tenant()->fantasy_name ?? 'Old School Barber' !!}. Todos os direitos reservados. | Desenvolvido com o estilo clássico das barbearias americanas.</p>
        </div>
    </footer>
