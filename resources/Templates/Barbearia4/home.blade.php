...
<head>
    ...
    <style>
        ...
        * {
        ...
        .hero {
            height: 100vh;
            background: linear-gradient(rgba(58, 44, 30, 0.3), rgba(58, 44, 30, 0.3)), url('/images/Barbearia4/photo.avif');
        ...
        <div class="container">
            ...
            <div class="servicos-grid">
                <div class="servico-card">
                    <div class="servico-img" style="background-image: url('images/Barbearia4/corte1.jpeg');"></div>
                ...
                <div class="servico-card">
                    <div class="servico-img" style="background-image: url('images/Barbearia4/barba1.jpeg');"></div>
                    <div class="servico-content">
                        <h3>BARBA RANCHER</h3>
                ...
                <div class="servico-card">
                    <div class="servico-img" style="background-image: url('images/Barbearia4/combo.jpg');"></div>
                    <div class="servico-content">
                        <h3>COMBO XERIFE</h3>
    ...
    <section class="sobre" id="sobre">
        <div class="container">
            <div class="sobre-content">
                <div class="sobre-img">
                    <img src="https://images.unsplash.com/photo-1585747860715-2ba37e788b70?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1474&q=80" alt="Interior da barbearia">
                </div>
