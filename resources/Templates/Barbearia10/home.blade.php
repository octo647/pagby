...
<body>
    ...
    <header>
        <div class="logo">
            ...
            <div class="logo-text">FUNK BARBER</div>
        </div>
        ...
        <button class="header-btn" onclick="openWhatsApp()">
            <a href="{{route('login')}}"><i class="fab fa-whatsapp"></i> AGENDAR</a>
        </button>
    </header>
    ...
    <section class="gallery" id="gallery">
        ...
        <div class="gallery-grid">
            <div class="gallery-item">
                <img src="https://images.unsplash.com/photo-1599351431202-1e0f0137899a?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Corte no estilo">
            ...
            <div class="gallery-item">
                <img src="https://images.unsplash.com/photo-1622286342621-4bd786c2447c?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Barbearia movimentada">
                <div class="gallery-overlay">
            ...
            <div class="gallery-item">
                <img src="https://images.unsplash.com/photo-1567894340315-735d7c361db0?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Desenho na navalha">
                <div class="gallery-overlay">
    ...
    <footer id="contact">
        <div class="footer-content">
            ...
            <div class="footer-section">
                ...
                <div class="contact-info">
                    ...
                    <p><i class="fas fa-phone"></i> (11) 9 8888-7777</p>
        ...
        <div class="copyright">
            <p>© 2023 FUNK BARBER | Orgulho da quebrada! 🎵 "Aqui o pobre é rico e o playboy não entra" 🎵</p>
        </div>
    </footer>
    ...
    <script>
        ...
        function openInstagram() {
            window.open('https://instagram.com/funkbarber', '_blank');
        }
        ...
        // Simular toque de música ao carregar a página
