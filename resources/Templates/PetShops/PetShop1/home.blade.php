...
<head>
    ...
    <title>{{ tenant()->fantasy_name ?? 'PetShop Amigo Fiel' }} - O melhor para seu pet</title>
    ...
    <style>
        * {
        ...
        /* Hero Section */
        .hero {
            background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('images/PetShop/petshop.jpg');
...
<body>
        ...
        <div class="container">
            <div class="header-container">
                <div class="logo">
                    ...
                    <h1>{{ tenant()->fantasy_name ?? 'PetShop Amigo Fiel' }}</h1>
                </div>
                <nav>
    ...
    <section class="hero" id="home">
        <div class="container">
            ...
            <p>Use nosso serviço de agendamento online para marcar uma consulta ou serviço de forma rápida e prática.</p>
            <a href="/login" class="btn">Agende</a>
        </div>
    </section>
        ...
        <div class="container">
            <div class="about-content">
                <div class="about-text">
                    <h2>Sobre Nós</h2>
                    <p>{{ tenant()->fantasy_name ?? 'PetShop Amigo Fiel' }} nasceu do amor pelos animais e da vontade de oferecer o melhor cuidado para os pets da nossa comunidade. Com mais de 10 anos de experiência, nossa equipe é formada por profissionais apaixonados e qualificados.</p>
    ...
    <section class="cta">
        <div class="container">
            ...
            <a href="https://wa.me/{{ tenant()->whatsapp ?? '5511999999999' }}" class="btn btn-light">Ligue agora</a>
        </div>
    </section>
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-column">
                    <h3>{{ tenant()->fantasy_name ?? 'PetShop Amigo Fiel' }}</h3>
                ...
                <div class="footer-column">
                    <h3>Contato</h3>
                    <ul>
                        <li><i class="fas fa-map-marker-alt"></i> {{ tenant()->address ?? 'Rua dos Animais, 123' }}</li>
                        <li><i class="fas fa-city"></i> {{ tenant()->city ?? 'São Paulo - SP' }}</li>
                        <li><i class="fas fa-phone"></i> {{ tenant()->phone ?? '(11) 99999-9999' }}</li>
                        <li><i class="fas fa-envelope"></i> {{ tenant()->email ?? 'contato@petshopamigofiel.com' }}</li>
                        <li><i class="fas fa-clock"></i> Seg-Sex: 8h-18h | Sáb: 8h-14h</li>
                    </ul>
                </div>
            </div>
            <div class="copyright">
                <p>&copy; 2023 {{ tenant()->fantasy_name ?? 'PetShop Amigo Fiel' }}. Todos os direitos reservados.</p>
            </div>
        </div>
    </footer>
