...
<head>
    ...
    <title>{{ tenant()->fantasy_name ?? 'Barbearia Salon Dumont' }}</title>
        ...
        <section id="galeria" class="mb-16 w-full max-w-6xl fade-in">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                <div class="gallery-item rounded-lg overflow-hidden shadow-lg">
                    <img src="/images/Barbearia1/corte.jpg" alt="Corte de Cabelo" class="w-full h-48 object-cover">
                </div>
                <div class="gallery-item rounded-lg overflow-hidden shadow-lg">
                    <img src="/images/Barbearia1/barba.jpg" alt="Barba" class="w-full h-48 object-cover">
                </div>
                <div class="gallery-item rounded-lg overflow-hidden shadow-lg">
                    <img src="/images/Barbearia1/manicure.jpg" alt="Manicure" class="w-full h-48 object-cover">
                </div>
                <div class="gallery-item rounded-lg overflow-hidden shadow-lg">
                    <img src="/images/Barbearia1/coloracao.jpg" alt="Coloração" class="w-full h-48 object-cover">
                </div>
                <div class="gallery-item rounded-lg overflow-hidden shadow-lg">
                    <img src="/images/Barbearia1/ambiente.jpeg" alt="Ambiente" class="w-full h-48 object-cover">
                </div>
                <div class="gallery-item rounded-lg overflow-hidden shadow-lg">
                    <img src="/images/Barbearia1/ambiente2.jpeg" alt="Ambiente 2" class="w-full h-48 object-cover bg-gray-700 flex items-center justify-center">
