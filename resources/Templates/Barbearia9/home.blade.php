...
<head>
    ...
    <title>Barbearia do Zé - Estilo Quebrada</title>
...
<body>
    ...
    <!-- Botão WhatsApp fixo -->
    <a href="https://wa.me/5511999999999?text=Olá! Gostaria de agendar um horário na barbearia" class="whatsapp-float" target="_blank">
    ...
    <header>
        <div class="logo">
            ...
            <div>
                <div class="logo-text">BARBEARIA DO ZÉ</div>
    ...
    <section class="hero" id="home">
        <div class="hero-content">
            <h1>BARBEARIA DA <span>QUEBRADA</span></h1>
            ...
            <div class="hero-buttons">
                <button class="btn-whatsapp" onclick="openWhatsApp()">
                    <i class="fab fa-whatsapp"></i> AGENDAR PELO ZAP
                </button>
                <button class="btn-call" onclick="callBarber()">
    ...
    <section class="prices" id="prices">
        ...
        <div class="prices-grid">
            <div class="price-card">
                ...
                <button class="btn-whatsapp" style="width: 100%; justify-content: center;">AGENDAR</button>
            </div>
            ...
            <div class="price-card">
                ...
                <button class="btn-whatsapp" style="width: 100%; justify-content: center; background-color: var(--favela-red);">PROMOÇÃO</button>
            </div>
        ...
        <div class="location-content">
            <div class="location-info">
                ...
                <div class="location-details">
                    <p><i class="fas fa-map-marker-alt"></i> Rua da Amizade, 123 - Vila Esperança</p>
    ...
    <script>
        ...
        function callBarber() {
            if(confirm("Ligar para a Barbearia do Zé?\n(11) 9 9999-9999")) {
